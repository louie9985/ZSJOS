...
export const useMessage = () => {
  ...
  return {
    ...
    notify(content: string) {
      ElNotification.info({ message: content, position: 'bottom-right' })
    },
    // 错误通知
    notifyError(content: string) {
      ElNotification.error({ message: content, position: 'bottom-right' })
    },
    // 成功通知
    notifySuccess(content: string) {
      ElNotification.success({ message: content, position: 'bottom-right' })
    },
    // 警告通知
    notifyWarning(content: string) {
      ElNotification.warning({ message: content, position: 'bottom-right' })
    },
    // 确认窗体
