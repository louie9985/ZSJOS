<template>
  ...
  <ContentWrap>
    <el-table v-loading="loading" :data="list" @selection-change="handleRowCheckboxChange">
      ...
      <el-table-column label="通知标题" prop="title" width="180" :show-overflow-tooltip="true" />
      <el-table-column label="通知摘要" prop="summary" width="220" :show-overflow-tooltip="true" />
      <el-table-column
        label="完整正文"
        align="center"
        prop="content"
