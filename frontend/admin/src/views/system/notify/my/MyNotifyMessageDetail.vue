<template>
  <Dialog v-model="dialogVisible" :max-height="500" :scroll="true" title="消息详情">
    <el-descriptions :column="1" border>
      ...
      <el-descriptions-item label="标题">{{ detailData.templateTitle }}</el-descriptions-item>
      <el-descriptions-item label="摘要">{{ detailData.templateSummary }}</el-descriptions-item>
