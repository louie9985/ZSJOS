...
export const APP_ROUTES = {
  ...
  LEAD_EDUCATION_SELF_SOURCED: '/zsjos/leads/education-self-sourced',
  ...
  SALES_PERFORMANCE: '/zsjos/sales-performance',
  SALES_PERFORMANCE_TARGET: '/zsjos/sales-performance-target',
  ...
  WORK_ORDER_CREATE: '/zsjos/work-orders/create',
  WORK_ORDER_AVAILABLE: '/zsjos/work-orders/available',
  WORK_ORDER_MINE: '/zsjos/work-orders/mine',
  ...
  LEAD_FOLLOW_UP_CALENDAR: '/calendar/sales-lead-follow-up',
  ...
  MATERIAL_MANAGEMENT: '/zsjos/material-library/manage',
  MATERIAL_APPROVALS: '/zsjos/material-library/approvals',
...
export const RENDERABLE_APP_ROUTES = new Set([
  ...
  APP_ROUTES.LEAD_EDUCATION_SELF_SOURCED,
  ...
  APP_ROUTES.SALES_PERFORMANCE,
  APP_ROUTES.SALES_PERFORMANCE_TARGET,
  ...
  APP_ROUTES.FEEDBACK,
  APP_ROUTES.WORK_ORDER_CREATE,
  APP_ROUTES.WORK_ORDER_AVAILABLE,
  APP_ROUTES.WORK_ORDER_MINE,
...
export const DICT_TYPE = {
  ...
  LEAD_SALES_STAGE: "zsjos_lead_sales_stage",
