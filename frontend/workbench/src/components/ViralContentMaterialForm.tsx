...
export default function ViralContentMaterialForm(props: ComponentProps<typeof ViralAccountMaterialForm> & { showDraftNavigation?: boolean }) {
  ...
  return <ViralAccountMaterialForm {...props} requireDraftContent titleFieldKey="work_title" coverLabel="封面图"
    onSaved={result => {
      ...
      if (!result.submitted && props.showDraftNavigation !== false) modal.success({
        title: '草稿保存成功',
