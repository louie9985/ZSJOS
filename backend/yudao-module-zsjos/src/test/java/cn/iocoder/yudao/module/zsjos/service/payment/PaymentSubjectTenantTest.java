...
class PaymentSubjectTenantTest {
    @Test
    void skuAssociationAndCodeQueriesRespectTenantAndLogicalDeletion() {
        ...
        try (var connection = source.getConnection()) {
            ...
            jdbc.execute("INSERT INTO zsjos_payment_subject(id,subject_code,status,is_default,tenant_id,deleted) VALUES(10,'default-one',0,TRUE,1,0),(20,'default-two',0,TRUE,2,0),(30,'deleted',0,TRUE,1,1),(40,'disabled',1,TRUE,1,0),(50,'school',0,FALSE,1,0),(60,'school',0,FALSE,2,0),(70,'company',0,FALSE,1,1),(80,'company',0,FALSE,2,0)");
            ...
            try (var session = new MybatisSqlSessionFactoryBuilder().build(config).openSession()) {
                ...
                assertEquals(50L, subjects.selectByCode("school").getId());
                assertNull(subjects.selectByCode("company"));
                assertEquals(1, subjects.selectByCode("disabled").getStatus());
                ...
                assertEquals(60L, subjects.selectByCode("school").getId());
                assertEquals(80L, subjects.selectByCode("company").getId());
