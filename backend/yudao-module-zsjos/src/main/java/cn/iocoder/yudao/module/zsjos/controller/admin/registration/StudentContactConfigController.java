...
public class StudentContactConfigController {
    ...
    public CommonResult<Long> copy() { return success(service.copyDraft()); }
    ...
    @Data public static class PublishReq { @NotNull private Long id; @NotNull private Integer version; }
}
