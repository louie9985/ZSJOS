...
@Schema(description = "管理后台 - 产品支付主体批量配置 Request VO")
@Data
public class ProductPaymentSubjectBatchConfigReqVO {

    @Schema(description = "产品编号列表", requiredMode = Schema.RequiredMode.REQUIRED, example = "[1, 2, 3]")
