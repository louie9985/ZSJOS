...
public class WorkOrderController {
    ...
    @GetMapping("/my-page") @Operation(summary = "我的工单") @PreAuthorize("@ss.hasPermission('zsjos:work-order:query')") public CommonResult<PageResult<WorkOrderRespVO>> myPage(@Valid WorkOrderMyPageReqVO req) { return success(service.readPage(req, getLoginUserId())); }
