...
public class DictDataServiceImplTest extends BaseDbUnitTest {
    ...
    public void testGetDictDataList() {
        ...
        assertPojoEquals(dictDataDO01, dictDataDOList.get(0));
        assertPojoEquals(dictDataDO02, dictDataDOList.get(1));
    }

    @Test
    public void testGetDictDataListByDictType() {
        DictDataDO higherSortDictData = randomDictDataDO().setDictType("yunai").setSort(20);
        dictDataMapper.insert(higherSortDictData);
        DictDataDO lowerSortDictData = randomDictDataDO().setDictType("yunai").setSort(10);
        dictDataMapper.insert(lowerSortDictData);
        dictDataMapper.insert(randomDictDataDO().setDictType("other").setSort(30));

        List<DictDataDO> dictDataList = dictDataService.getDictDataListByDictType("yunai");

        assertEquals(2, dictDataList.size());
        assertPojoEquals(higherSortDictData, dictDataList.get(0));
        assertPojoEquals(lowerSortDictData, dictDataList.get(1));
    }
    ...
    public void testGetDictDataPage() {
        ...
        DictDataDO lowerSortDictData = cloneIgnoreId(dbDictData, o -> o.setSort(10));
        dictDataMapper.insert(lowerSortDictData);
        // 测试 label 不匹配
        ...
        assertPojoEquals(lowerSortDictData, pageResult.getList().get(1));
    }
