...
public interface ErrorCodeConstants {
    ...
    ErrorCode SOCIAL_CLIENT_PARTNER_WECOM_UNAVAILABLE = new ErrorCode(1_002_018_212, "兼职企业微信应用未配置、已停用或配置不完整，请联系管理员");
    ...
    // ========== 业务通知规则 1-002-029-000 ==========
    ErrorCode NOTIFY_SCENE_NOT_EXISTS = new ErrorCode(1_002_029_000, "业务通知场景【{}】不存在");
    ErrorCode NOTIFY_TEMPLATE_PARAM_INVALID = new ErrorCode(1_002_029_001, "模板变量【{}】不属于当前业务场景");
    ErrorCode NOTIFY_RULE_NOT_EXISTS = new ErrorCode(1_002_029_002, "业务通知规则不存在");
    ErrorCode NOTIFY_RULE_TEMPLATE_SCENE_MISMATCH = new ErrorCode(1_002_029_003, "通知模板与业务场景不匹配");
    ...
    ErrorCode AREA_CODE_DUPLICATE = new ErrorCode(1_002_030_001, "地区编码已存在");
    ErrorCode AREA_NAME_DUPLICATE = new ErrorCode(1_002_030_002, "同一上级下已存在同名地区");
    ErrorCode AREA_PARENT_NOT_EXISTS = new ErrorCode(1_002_030_003, "上级地区不存在");
    ErrorCode AREA_PARENT_INVALID = new ErrorCode(1_002_030_004, "地区层级无效或上级地区形成循环");
