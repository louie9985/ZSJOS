...
public interface OAuth2RefreshTokenMapper extends BaseMapperX<OAuth2RefreshTokenDO> {
    ...
    @TenantIgnore
    default List<OAuth2RefreshTokenDO> selectListByUserIdAndTypeAndClientId(Long userId, Integer userType,
                                                                             String clientId, LocalDateTime now) {
        return selectList(new LambdaQueryWrapperX<OAuth2RefreshTokenDO>()
                ...
                .gt(OAuth2RefreshTokenDO::getExpiresTime, now)
                .orderByAsc(OAuth2RefreshTokenDO::getCreateTime));
    }
