...
public interface LogRecordConstants {
    ...
    String INFRA_DATABASE_ADMIN_UPDATE_SUCCESS = "在数据源【{{#reqVO.dataSourceConfigId}}】表【{{#reqVO.tableName}}】更新主键【{{#reqVO.primaryKeyValue}}】字段【{{#reqVO.values.keySet()}}】";
    String INFRA_DATABASE_ADMIN_DELETE_SUB_TYPE = "删除数据库行";
    String INFRA_DATABASE_ADMIN_DELETE_SUCCESS = "在数据源【{{#reqVO.dataSourceConfigId}}】表【{{#reqVO.tableName}}】删除主键【{{#reqVO.primaryKeyValue}}】";
