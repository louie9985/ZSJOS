...
CREATE TABLE IF NOT EXISTS `zsjos_feedback` (
 ...
 PRIMARY KEY (`id`), UNIQUE KEY `uk_tenant_work_order` (`tenant_id`,`work_order_id`), UNIQUE KEY `uk_tenant_feedback_no` (`tenant_id`,`feedback_no`), KEY `idx_submitter_activity` (`tenant_id`,`submitter_user_id`,`last_activity_at`), KEY `idx_type_status_activity` (`tenant_id`,`feedback_type`,`status`,`last_activity_at`), KEY `idx_assignee_status` (`tenant_id`,`assignee_user_id`,`status`)
