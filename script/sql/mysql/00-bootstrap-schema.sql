...
CREATE TABLE IF NOT EXISTS `zsjos_feedback_no_daily_counter` (
 `id` bigint NOT NULL AUTO_INCREMENT, `tenant_id` bigint NOT NULL DEFAULT 0, `sequence_date` date NOT NULL, `feedback_type` varchar(16) NOT NULL, `current_value` bigint NOT NULL DEFAULT 0,
 ...
 PRIMARY KEY (`id`), UNIQUE KEY `uk_tenant_date_type` (`tenant_id`,`sequence_date`,`feedback_type`)
