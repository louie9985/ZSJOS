...
CREATE TABLE IF NOT EXISTS hrm_attendance_group (
    ...
    open_wifi_card boolean NOT NULL DEFAULT 0,
    open_point_card boolean NOT NULL DEFAULT 0,
    shifts text NOT NULL,
    rest boolean NOT NULL DEFAULT 1,
    special_dates text NOT NULL,
    points text NOT NULL,
    wifis text NOT NULL,
    deduct_rule text NOT NULL,
    default_status boolean NOT NULL DEFAULT 0,
    creator varchar(64) DEFAULT '',
    create_time timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
    updater varchar(64) DEFAULT '',
    update_time timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE IF NOT EXISTS hrm_salary_option_template (
    ...
    calculate_enabled boolean NOT NULL DEFAULT 1,
    creator varchar(64) DEFAULT '',
    create_time timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
    updater varchar(64) DEFAULT '',
    update_time timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE IF NOT EXISTS hrm_insurance_employee_info (
    id bigint NOT NULL AUTO_INCREMENT,
    employee_id bigint NOT NULL,
    first_social_security boolean NOT NULL DEFAULT 0,
    first_accumulation_fund boolean NOT NULL DEFAULT 0,
...
CREATE TABLE IF NOT EXISTS hrm_performance_plan (
    ...
    target_confirmation bit DEFAULT 0 NOT NULL,
    target_confirmation_stage text DEFAULT NULL,
    review_stages text NOT NULL,
    result_audit bit DEFAULT 1 NOT NULL,
    result_audit_stages text DEFAULT NULL,
    result_confirmation bit DEFAULT 1 NOT NULL,
