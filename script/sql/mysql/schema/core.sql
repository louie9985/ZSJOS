...
CREATE TABLE IF NOT EXISTS `system_notify_template` (
  ...
  `channel_code` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'in_app',
  `sms_template_id` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `wecom_message_type` varchar(16) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `status` tinyint NOT NULL COMMENT '状态',
  `remark` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '备注',
  `creator` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT '' COMMENT '创建者',
  `create_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
...
CREATE TABLE IF NOT EXISTS `zsjos_business_task` (
  ...
  `title_snapshot` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '稳定标题摘要',
  `summary_snapshot` varchar(1000) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '稳定内容摘要',
  `action_code` varchar(64) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '受控前端动作编码',
...
CREATE TABLE IF NOT EXISTS `zsjos_lead` (
  ...
  `source_channel_label_snapshot` varchar(128) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '来源渠道选择时标签快照',
  ...
  `no_progress_warned_at` datetime DEFAULT NULL COMMENT '无进展预警触发时间',
  ...
  `lead_category_label_snapshot` varchar(128) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '客资分类选择时标签快照',
...
CREATE TABLE IF NOT EXISTS `zsjos_lead_duplicate_review` (
  ...
  `submission_snapshot` json NOT NULL, `lead_category_label_snapshot` varchar(128) DEFAULT NULL,
  `source_channel_label_snapshot` varchar(128) DEFAULT NULL,
  `duplicate_flag` varchar(32) DEFAULT NULL, `duplicate_result` varchar(32) DEFAULT NULL,
  `primary_rule_code` varchar(64) DEFAULT NULL, `review_fingerprint` varchar(64) DEFAULT NULL,
  `match_rules` json NOT NULL, `candidate_snapshot` json NOT NULL,
...
CREATE TABLE IF NOT EXISTS `zsjos_lead_submitter_assist_request` (
  ...
  `requester_user_id` bigint NOT NULL, `problem` varchar(1000) NOT NULL, `expected_assistance` varchar(1000) NOT NULL,
  `remark` varchar(2000) DEFAULT NULL, `attachment_snapshots_json` json DEFAULT NULL,
  `submitter_type_snapshot` varchar(32) NOT NULL, `submitter_id_snapshot` bigint NOT NULL,
...
CREATE TABLE IF NOT EXISTS `zsjos_lead_follow_up_rule` (
  ...
  `no_progress_grace_days` int NOT NULL DEFAULT '2' COMMENT '无进展宽限天数',
  `no_progress_warning_days` int NOT NULL DEFAULT '7' COMMENT '无进展预警天数',
...
CREATE TABLE IF NOT EXISTS `zsjos_opportunity` (
  ...
  `person_id` bigint NOT NULL COMMENT 'Person 编号',
  `type` varchar(32) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '阶段一仅使用 initial_conversion',
  ...
  `deleted` bit(1) NOT NULL DEFAULT b'0' COMMENT '是否删除',
  `tenant_id` bigint NOT NULL DEFAULT '0' COMMENT '租户编号',
  `active_person_id` bigint GENERATED ALWAYS AS (CASE WHEN (`deleted` = b'0') THEN `person_id` ELSE NULL END) STORED COMMENT '活动客户商机唯一键',
  PRIMARY KEY (`id`),
...
CREATE TABLE IF NOT EXISTS `zsjos_order` (
  ...
  `repurchase_reason` varchar(1000) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '复购说明',
  `termination_reason` varchar(1000) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '终止原因',
  ...
  `active_repurchase_person_id` bigint GENERATED ALWAYS AS (CASE WHEN (`deleted` = b'0' AND `order_type` = 'repurchase' AND `status` IN ('pending_approval','revision_required')) THEN `person_id` ELSE NULL END) STORED COMMENT '活动复购客户唯一键',
  PRIMARY KEY (`id`),
...
CREATE TABLE IF NOT EXISTS `zsjos_order_supervisor_confirmation` (
  ...
  `supervisor_task_id` varchar(128) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'BPM 并行加签任务编号',
...
CREATE TABLE IF NOT EXISTS `zsjos_partner_invitation` (
  ...
  `invitation_scene` varchar(32) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'GENERAL' COMMENT 'GENERAL/STUDENT_PARTNER',
  `student_person_id` bigint DEFAULT NULL COMMENT '学员 Person 编号',
  `student_name_snapshot` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '邀请时学员原姓名快照',
  `student_mobile_snapshot` varchar(32) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '邀请时学员原手机号快照',
  `initiated_by_director_user_id` bigint DEFAULT NULL COMMENT '发起邀请的责任编导',
  `assignment_context_json` json DEFAULT NULL COMMENT '邀请时分配上下文快照',
  `active_student_person_id` bigint GENERATED ALWAYS AS (CASE WHEN `invitation_scene`='STUDENT_PARTNER' AND `status`='active' AND `deleted`=b'0' THEN `student_person_id` ELSE NULL END) STORED,
  ...
  `assigned_operator_user_id` bigint DEFAULT NULL COMMENT '普通邀请的归属运营；学员邀请为空',
  `assigned_operator_name_snapshot` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '普通邀请归属运营姓名快照',
...
CREATE TABLE IF NOT EXISTS `zsjos_payment_order` (
  ...
  `close_reason` varchar(500) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '关闭原因',
  `close_requested_at` datetime DEFAULT NULL COMMENT '取消发起时间；非空表示取消结果待确认',
  `close_attempts` int NOT NULL DEFAULT '0' COMMENT '关单尝试次数',
  `close_last_error` varchar(500) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '最近一次关单失败或结果未知的原因',
  `version` int NOT NULL DEFAULT '0' COMMENT '乐观锁版本',
  `creator` varchar(64) COLLATE utf8mb4_unicode_ci DEFAULT '' COMMENT '创建者',
  `create_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `updater` varchar(64) COLLATE utf8mb4_unicode_ci DEFAULT '' COMMENT '更新者',
...
CREATE TABLE IF NOT EXISTS `zsjos_registration_checklist_template_item` (`id` bigint NOT NULL AUTO_INCREMENT,`version_id` bigint NOT NULL,`item_key` varchar(64) NOT NULL,`item_type` varchar(32) NOT NULL,`title` varchar(100) NOT NULL,`sort` int NOT NULL,`enabled` bit(1) NOT NULL DEFAULT b'1',`system_required` bit(1) NOT NULL DEFAULT b'0',`attachment_required` bit(1) NOT NULL DEFAULT b'0',`creator` varchar(64) DEFAULT '',`create_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,`updater` varchar(64) DEFAULT '',`update_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,`deleted` bit(1) NOT NULL DEFAULT b'0',`tenant_id` bigint NOT NULL,PRIMARY KEY (`id`),UNIQUE KEY `uk_registration_version_item` (`tenant_id`,`version_id`,`item_key`,`deleted`)) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
CREATE TABLE IF NOT EXISTS `zsjos_registration_case_checklist_item` (`id` bigint NOT NULL AUTO_INCREMENT,`registration_case_id` bigint NOT NULL,`template_item_id` bigint NOT NULL,`item_key` varchar(64) NOT NULL,`item_type` varchar(32) NOT NULL,`title_snapshot` varchar(100) NOT NULL,`sort` int NOT NULL,`checked` bit(1) NOT NULL DEFAULT b'0',`attachment_required` bit(1) NOT NULL DEFAULT b'0',`checked_by_user_id` bigint DEFAULT NULL,`checked_at` datetime DEFAULT NULL,`version` int NOT NULL DEFAULT 0,`creator` varchar(64) DEFAULT '',`create_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,`updater` varchar(64) DEFAULT '',`update_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,`deleted` bit(1) NOT NULL DEFAULT b'0',`tenant_id` bigint NOT NULL,PRIMARY KEY (`id`),UNIQUE KEY `uk_registration_case_item` (`tenant_id`,`registration_case_id`,`template_item_id`,`deleted`)) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
CREATE TABLE IF NOT EXISTS `zsjos_registration_route_option` (`id` bigint NOT NULL AUTO_INCREMENT,`version_id` bigint NOT NULL,`option_key` varchar(64) NOT NULL,`department_id` bigint NOT NULL,`department_name_snapshot` varchar(100) NOT NULL,`assignee_type` varchar(32) NOT NULL,`sort` int NOT NULL,`enabled` bit(1) NOT NULL DEFAULT b'1',`system_required` bit(1) NOT NULL DEFAULT b'0',`creator` varchar(64) DEFAULT '',`create_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,`updater` varchar(64) DEFAULT '',`update_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,`deleted` bit(1) NOT NULL DEFAULT b'0',`tenant_id` bigint NOT NULL,PRIMARY KEY (`id`),UNIQUE KEY `uk_registration_version_route` (`tenant_id`,`version_id`,`option_key`,`deleted`)) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
CREATE TABLE IF NOT EXISTS `zsjos_registration_case_route` (`id` bigint NOT NULL AUTO_INCREMENT,`registration_case_id` bigint NOT NULL,`route_option_id` bigint NOT NULL,`option_key` varchar(64) NOT NULL,`department_id` bigint NOT NULL,`department_name_snapshot` varchar(100) NOT NULL,`assignee_type` varchar(32) NOT NULL,`selected` bit(1) NOT NULL DEFAULT b'0',`assignee_user_id` bigint DEFAULT NULL,`assignee_name_snapshot` varchar(100) DEFAULT NULL,`sort` int NOT NULL,`version` int NOT NULL DEFAULT 0,`creator` varchar(64) DEFAULT '',`create_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,`updater` varchar(64) DEFAULT '',`update_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,`deleted` bit(1) NOT NULL DEFAULT b'0',`tenant_id` bigint NOT NULL,PRIMARY KEY (`id`),UNIQUE KEY `uk_registration_case_route` (`tenant_id`,`registration_case_id`,`route_option_id`,`deleted`)) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
CREATE TABLE IF NOT EXISTS `zsjos_registration_item_attachment` (`id` bigint NOT NULL AUTO_INCREMENT,`registration_case_id` bigint NOT NULL,`checklist_item_id` bigint NOT NULL,`infra_file_id` bigint NOT NULL,`file_url` varchar(1024) NOT NULL,`original_name` varchar(255) NOT NULL,`content_type` varchar(128) DEFAULT NULL,`file_size` bigint NOT NULL,`uploaded_by_user_id` bigint NOT NULL,`uploaded_at` datetime NOT NULL,`creator` varchar(64) DEFAULT '',`create_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,`updater` varchar(64) DEFAULT '',`update_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,`deleted` bit(1) NOT NULL DEFAULT b'0',`tenant_id` bigint NOT NULL,PRIMARY KEY (`id`),KEY `idx_registration_attachment_item` (`tenant_id`,`checklist_item_id`,`uploaded_at`)) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
CREATE TABLE IF NOT EXISTS `zsjos_registration_command` (`id` bigint NOT NULL AUTO_INCREMENT,`registration_case_id` bigint NOT NULL,`command_type` varchar(32) NOT NULL,`idempotency_key` varchar(64) NOT NULL,`request_fingerprint` varchar(255) NOT NULL,`operator_user_id` bigint NOT NULL,`result_attachment_id` bigint DEFAULT NULL COMMENT '上传附件命令的精确结果附件编号',`creator` varchar(64) DEFAULT '',`create_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,`updater` varchar(64) DEFAULT '',`update_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,`deleted` bit(1) NOT NULL DEFAULT b'0',`tenant_id` bigint NOT NULL,PRIMARY KEY (`id`),UNIQUE KEY `uk_registration_command_key` (`tenant_id`,`idempotency_key`,`deleted`)) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE IF NOT EXISTS `zsjos_service_relation` (
  ...
  `delivery_stage` varchar(64) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '学习交付阶段',
...
CREATE TABLE IF NOT EXISTS `zsjos_student_contact_record` (
  `id` bigint NOT NULL AUTO_INCREMENT, `service_relation_id` bigint NOT NULL, `task_id` bigint DEFAULT NULL,
  ...
  `delivery_stage` varchar(64) DEFAULT NULL, `delivery_data_json` json DEFAULT NULL, `next_contact_at` datetime NOT NULL,
  ...
  `updater` varchar(64) DEFAULT '', `update_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `deleted` bit(1) NOT NULL DEFAULT b'0', `tenant_id` bigint NOT NULL, PRIMARY KEY (`id`),
  UNIQUE KEY `uk_tenant_idempotency` (`tenant_id`,`idempotency_key`), UNIQUE KEY `uk_tenant_task` (`tenant_id`,`task_id`),
...
CREATE TABLE IF NOT EXISTS `zsjos_student_contact_extension` (
  ...
  `reason_value` varchar(100) NOT NULL, `reason_label_snapshot` varchar(100) NOT NULL, `description` varchar(1000) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `zsjos_student_collaborator_assignment_log` (
  `id` bigint NOT NULL AUTO_INCREMENT, `service_relation_id` bigint NOT NULL, `collaborator_type` varchar(32) NOT NULL,
  `previous_user_id` bigint DEFAULT NULL, `assigned_user_id` bigint NOT NULL, `operator_user_id` bigint NOT NULL,
  `reason` varchar(500) DEFAULT NULL, `idempotency_key` varchar(128) NOT NULL, `creator` varchar(64) DEFAULT '',
  `create_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP, `updater` varchar(64) DEFAULT '',
  `update_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `deleted` bit(1) NOT NULL DEFAULT b'0', `tenant_id` bigint NOT NULL, PRIMARY KEY (`id`),
  UNIQUE KEY `uk_tenant_idempotency` (`tenant_id`,`idempotency_key`),
...
CREATE TABLE `zsjos_business_audit_log` (
  ...
  `source_type` varchar(32) NOT NULL DEFAULT 'EXPLICIT', `trace_id` varchar(64) DEFAULT NULL,
  `request_method` varchar(16) DEFAULT NULL, `request_path` varchar(500) DEFAULT NULL,
  `result_status` varchar(16) NOT NULL DEFAULT 'SUCCESS', `result_code` int DEFAULT NULL,
  `result_message` varchar(500) DEFAULT NULL, `occurred_at` datetime NOT NULL,
  `finished_at` datetime DEFAULT NULL, `duration_ms` bigint DEFAULT NULL, `creator` varchar(64) DEFAULT '',
  `create_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP, `updater` varchar(64) DEFAULT '',
  `update_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `deleted` bit(1) NOT NULL DEFAULT b'0', `tenant_id` bigint NOT NULL DEFAULT 0,
...
CREATE TABLE IF NOT EXISTS `zsjos_work_order` (
 ...
 `source_subject_type` varchar(32) NOT NULL DEFAULT 'ADMIN' COMMENT '发起主体类型', `source_user_id` bigint NOT NULL, `target_user_id` bigint DEFAULT NULL,
 ...
 `command_subject_type` varchar(32) NOT NULL DEFAULT 'ADMIN' COMMENT '命令主体类型', `command_user_id` bigint NOT NULL, `request_fingerprint` varchar(64) NOT NULL,
 ...
 KEY `idx_target_user` (`tenant_id`,`target_user_id`,`status`,`create_time`), KEY `idx_tenant_business_type` (`tenant_id`,`business_type`,`create_time`)
...
CREATE TABLE IF NOT EXISTS `zsjos_work_order_history` (
 ...
 `operator_subject_type` varchar(32) NOT NULL DEFAULT 'ADMIN' COMMENT '操作主体类型', `operator_user_id` bigint NOT NULL, `reason` varchar(1000) DEFAULT NULL,
 ...
 `updater` varchar(64) DEFAULT '', `update_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
 `deleted` bit(1) NOT NULL DEFAULT b'0', `deleted_time` datetime DEFAULT NULL,
 PRIMARY KEY (`id`), KEY `idx_order_time` (`tenant_id`,`work_order_id`,`operated_at`),
...
-- V149 feedback management baseline tables
CREATE TABLE IF NOT EXISTS `zsjos_feedback_no_daily_counter` ( `id` bigint NOT NULL AUTO_INCREMENT, `tenant_id` bigint NOT NULL DEFAULT 0, `sequence_date` date NOT NULL, `feedback_type` varchar(16) NOT NULL, `current_value` bigint NOT NULL DEFAULT 0, `creator` varchar(64) DEFAULT '', `create_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP, `updater` varchar(64) DEFAULT '', `update_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP, `deleted` bit(1) NOT NULL DEFAULT b'0', `deleted_time` datetime DEFAULT NULL, PRIMARY KEY (`id`), UNIQUE KEY `uk_tenant_date_type` (`tenant_id`,`sequence_date`,`feedback_type`) ) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='反馈业务编号日流水';
CREATE TABLE IF NOT EXISTS `zsjos_feedback` ( `id` bigint NOT NULL AUTO_INCREMENT, `tenant_id` bigint NOT NULL DEFAULT 0, `work_order_id` bigint NOT NULL, `feedback_type` varchar(16) NOT NULL, `feedback_no` varchar(32) NOT NULL, `title` varchar(255) NOT NULL, `title_field_key` varchar(64) NOT NULL, `form_id` bigint NOT NULL, `form_snapshot_json` longtext NOT NULL, `value_snapshot_json` longtext NOT NULL, `support_dict_type` varchar(100) DEFAULT NULL, `support_type_value` varchar(100) DEFAULT NULL, `support_type_label_snapshot` varchar(100) DEFAULT NULL, `status` varchar(24) NOT NULL, `submitter_subject_type` varchar(32) NOT NULL DEFAULT 'ADMIN' COMMENT '提交主体类型', `submitter_user_id` bigint NOT NULL, `submitter_name_snapshot` varchar(128) DEFAULT NULL, `partner_id` bigint DEFAULT NULL COMMENT '合作方主体编号', `assignee_user_id` bigint DEFAULT NULL, `assignee_name_snapshot` varchar(128) DEFAULT NULL, `last_reply_summary` varchar(500) DEFAULT NULL, `last_activity_at` datetime NOT NULL, `unread_for_submitter` bit(1) NOT NULL DEFAULT b'0', `unread_for_assignee` bit(1) NOT NULL DEFAULT b'0', `approval_enabled` bit(1) NOT NULL DEFAULT b'0', `process_instance_id` varchar(64) DEFAULT NULL, `approval_round_no` int NOT NULL DEFAULT 0, `reject_reason` varchar(1000) DEFAULT NULL, `completed_result` text DEFAULT NULL, `result_attachment_ids_json` json DEFAULT NULL, `config_version` int NOT NULL DEFAULT 0, `version` int NOT NULL DEFAULT 0, `creator` varchar(64) DEFAULT '', `create_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP, `updater` varchar(64) DEFAULT '', `update_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP, `deleted` bit(1) NOT NULL DEFAULT b'0', `deleted_time` datetime DEFAULT NULL, PRIMARY KEY (`id`), UNIQUE KEY `uk_tenant_work_order` (`tenant_id`,`work_order_id`), UNIQUE KEY `uk_tenant_feedback_no` (`tenant_id`,`feedback_no`), KEY `idx_submitter_activity` (`tenant_id`,`submitter_user_id`,`last_activity_at`), KEY `idx_submitter_subject_activity` (`tenant_id`,`submitter_subject_type`,`submitter_user_id`,`deleted`,`last_activity_at`), KEY `idx_feedback_partner` (`tenant_id`,`partner_id`,`deleted`), KEY `idx_type_status_activity` (`tenant_id`,`feedback_type`,`status`,`last_activity_at`), KEY `idx_assignee_status` (`tenant_id`,`assignee_user_id`,`status`) ) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='ZSJOS 需求与反馈扩展';
CREATE TABLE IF NOT EXISTS `zsjos_feedback_round` ( `id` bigint NOT NULL AUTO_INCREMENT, `tenant_id` bigint NOT NULL DEFAULT 0, `feedback_id` bigint NOT NULL, `round_no` int NOT NULL, `status` varchar(24) NOT NULL, `form_snapshot_json` longtext NOT NULL, `value_snapshot_json` longtext NOT NULL, `approval_context_json` longtext NOT NULL, `process_instance_id` varchar(64) DEFAULT NULL, `business_key` varchar(180) NOT NULL, `reject_reason` varchar(1000) DEFAULT NULL, `submitted_at` datetime NOT NULL, `creator` varchar(64) DEFAULT '', `create_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP, `updater` varchar(64) DEFAULT '', `update_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP, `deleted` bit(1) NOT NULL DEFAULT b'0', `deleted_time` datetime DEFAULT NULL, PRIMARY KEY (`id`), UNIQUE KEY `uk_feedback_round` (`tenant_id`,`feedback_id`,`round_no`), UNIQUE KEY `uk_feedback_round_key` (`tenant_id`,`business_key`), KEY `idx_feedback_round` (`tenant_id`,`feedback_id`,`round_no`) ) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='反馈提交审批轮次快照';
CREATE TABLE IF NOT EXISTS `zsjos_feedback_reply` ( `id` bigint NOT NULL AUTO_INCREMENT, `tenant_id` bigint NOT NULL DEFAULT 0, `feedback_id` bigint NOT NULL, `author_user_id` bigint NOT NULL, `author_name_snapshot` varchar(128) DEFAULT NULL, `author_type` varchar(16) NOT NULL, `content` text NOT NULL, `attachment_ids_json` json DEFAULT NULL, `idempotency_key` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL, `creator` varchar(64) DEFAULT '', `create_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP, `updater` varchar(64) DEFAULT '', `update_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP, `deleted` bit(1) NOT NULL DEFAULT b'0', `deleted_time` datetime DEFAULT NULL, PRIMARY KEY (`id`), UNIQUE KEY `uk_feedback_reply_key` (`tenant_id`,`feedback_id`,`idempotency_key`), KEY `idx_feedback_reply_time` (`tenant_id`,`feedback_id`,`create_time`) ) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='反馈沟通回复';
CREATE TABLE IF NOT EXISTS `zsjos_feedback_survey` ( `id` bigint NOT NULL AUTO_INCREMENT, `tenant_id` bigint NOT NULL DEFAULT 0, `feedback_id` bigint NOT NULL, `status` varchar(16) NOT NULL, `form_id` bigint NOT NULL, `form_snapshot_json` longtext NOT NULL, `value_snapshot_json` longtext DEFAULT NULL, `requested_by_user_id` bigint NOT NULL, `requested_by_name_snapshot` varchar(128) DEFAULT NULL, `requested_at` datetime NOT NULL, `submitter_user_id` bigint NOT NULL, `submitted_at` datetime DEFAULT NULL, `creator` varchar(64) DEFAULT '', `create_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP, `updater` varchar(64) DEFAULT '', `update_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP, `deleted` bit(1) NOT NULL DEFAULT b'0', `deleted_time` datetime DEFAULT NULL, PRIMARY KEY (`id`), UNIQUE KEY `uk_feedback_survey` (`tenant_id`,`feedback_id`) ) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='反馈满意度调查';
CREATE TABLE IF NOT EXISTS `zsjos_feedback_config` ( `id` bigint NOT NULL AUTO_INCREMENT, `tenant_id` bigint NOT NULL DEFAULT 0, `feedback_type` varchar(16) NOT NULL, `form_id` bigint NOT NULL, `title_field_key` varchar(64) NOT NULL, `dispatcher_user_ids_json` json NOT NULL, `approval_enabled` bit(1) NOT NULL DEFAULT b'0', `bpm_process_definition_key` varchar(128) DEFAULT NULL, `last_idempotency_key` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL, `last_request_fingerprint` varchar(64) DEFAULT NULL, `version` int NOT NULL DEFAULT 0, `creator` varchar(64) DEFAULT '', `create_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP, `updater` varchar(64) DEFAULT '', `update_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP, `deleted` bit(1) NOT NULL DEFAULT b'0', `deleted_time` datetime DEFAULT NULL, PRIMARY KEY (`id`), UNIQUE KEY `uk_tenant_feedback_type` (`tenant_id`,`feedback_type`) ) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='反馈设置';
...
CREATE TABLE IF NOT EXISTS `zsjos_content_version` (
  ...
  `title_snapshot` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '标题快照',
  `topic_snapshot` varchar(1000) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '选题快照',
  `cover_snapshot_json` json DEFAULT NULL COMMENT '封面文件快照',
