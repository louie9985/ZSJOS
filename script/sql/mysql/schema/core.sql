...
INSERT IGNORE INTO `ACT_GE_PROPERTY` (`NAME_`,`VALUE_`,`REV_`) VALUES
...
CREATE TABLE IF NOT EXISTS `ACT_HI_PROCINST` (
  ...
  `END_USER_ID_` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_bin DEFAULT NULL,
...
INSERT IGNORE INTO `ACT_ID_PROPERTY` (`NAME_`,`VALUE_`,`REV_`) VALUES
  ('schema.version','8.0.0.0',1);
...
CREATE TABLE IF NOT EXISTS `bpm_form` (
  ...
  `tenant_id` bigint NOT NULL DEFAULT '0' COMMENT '租户编号',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=12 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='BPM 表单定义表';
...
CREATE TABLE IF NOT EXISTS `infra_job` (
  ...
  `deleted` bit(1) NOT NULL DEFAULT b'0' COMMENT '是否删除',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='定时任务表';
...
CREATE TABLE IF NOT EXISTS `system_dept` (
  ...
  `tenant_id` bigint NOT NULL DEFAULT '0' COMMENT '租户编号',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=1122 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='部门表';
...
CREATE TABLE IF NOT EXISTS `system_dict_data` (
  ...
  `deleted` bit(1) NOT NULL DEFAULT b'0' COMMENT '是否删除',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=1061624 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='字典数据表';
...
CREATE TABLE IF NOT EXISTS `system_dict_type` (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=1061219 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='字典类型表';
...
CREATE TABLE IF NOT EXISTS `system_menu` (
  ...
  `deleted` bit(1) NOT NULL DEFAULT b'0' COMMENT '是否删除',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=602115 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='菜单权限表';
...
CREATE TABLE IF NOT EXISTS `system_notice` (
  ...
  `highlight_until` datetime DEFAULT NULL COMMENT '高亮提醒截止时间',
  `creator` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT '' COMMENT '创建者',
  `create_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `updater` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT '' COMMENT '更新者',
  `update_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
...
CREATE TABLE IF NOT EXISTS `system_notice_attachment` (
  ...
  `file_name` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '文件名快照',
  `mime_type` varchar(128) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'MIME类型快照',
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `uk_notice_file` (`tenant_id`,`notice_id`,`infra_file_id`),
...
CREATE TABLE IF NOT EXISTS `system_notice_read` (
  ...
  `tenant_id` bigint NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
  UNIQUE KEY `uk_notice_reader` (`tenant_id`,`notice_id`,`user_id`),
...
CREATE TABLE IF NOT EXISTS `system_notify_business_outbox` (
  ...
  `source_event_key` varchar(128) COLLATE utf8mb4_unicode_ci NOT NULL,
  ...
  `deleted` bit(1) NOT NULL DEFAULT b'0',
  PRIMARY KEY (`id`),
  UNIQUE KEY `uk_notify_outbox_event_rule` (`tenant_id`,`source_event_key`,`target_rule_id`),
...
-- system_notify_channel_config
CREATE TABLE IF NOT EXISTS `system_notify_channel_config` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `channel_code` varchar(32) NOT NULL,
  `enabled` bit(1) NOT NULL DEFAULT b'0',
  `config_ref` varchar(255) DEFAULT NULL,
  `masked_config` varchar(1024) DEFAULT NULL,
  ...
  `tenant_id` bigint NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
  UNIQUE KEY `uk_notify_channel_tenant` (`tenant_id`,`channel_code`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='租户通知渠道配置';

-- system_notify_delivery
CREATE TABLE IF NOT EXISTS `system_notify_delivery` (
  ...
  `tenant_id` bigint NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
  UNIQUE KEY `uk_notify_delivery_event` (`tenant_id`,`rule_id`,`user_id`,`source_event_key`,`channel_code`),
  KEY `idx_notify_delivery_status` (`tenant_id`,`status`,`next_retry_time`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='通知渠道异步投递记录';
...
CREATE TABLE IF NOT EXISTS `system_notify_message` (
  ...
  `template_title` varchar(128) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '标题快照',
  `template_summary` varchar(512) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '摘要快照',
  `template_content` text COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '正文快照',
  `template_type` int NOT NULL COMMENT '模版类型',
  `template_params` text COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '模板参数',
  `notify_rule_id` bigint DEFAULT NULL COMMENT '通知规则编号',
  `scene_code` varchar(64) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '业务场景编码',
  `channel_code` varchar(32) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'in_app' COMMENT '通知渠道',
  `sms_template_id` varchar(64) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '短信模板编号',
  `wecom_message_type` varchar(16) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '企微消息类型',
  `source_event_key` varchar(128) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '来源事件键',
  `action_type` varchar(32) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '受控点击动作',
...
CREATE TABLE IF NOT EXISTS `system_notify_rule` (
  ...
  `scene_code` varchar(64) COLLATE utf8mb4_unicode_ci NOT NULL,
  `channel_code` varchar(32) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'in_app',
  `template_id` bigint NOT NULL,
  `recipient_roles` text COLLATE utf8mb4_unicode_ci NOT NULL,
  `specified_user_ids` text COLLATE utf8mb4_unicode_ci NOT NULL,
  `action_type` varchar(32) COLLATE utf8mb4_unicode_ci NOT NULL,
  `timing_stage` varchar(16) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '提醒阶段：advance/due/overdue',
...
) ENGINE=InnoDB AUTO_INCREMENT=145 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='租户业务通知规则';
...
CREATE TABLE IF NOT EXISTS `system_notify_template` (
  ...
  `sms_template_id` varchar(64) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '短信模板编号',
  `wecom_message_type` varchar(16) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '企微消息类型',
  `title` varchar(128) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '标题模板',
  `summary` varchar(512) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '摘要模板',
  `content` text COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '正文模板',
  `type` tinyint NOT NULL COMMENT '类型',
  `params` text COLLATE utf8mb4_unicode_ci COMMENT '参数数组',
  `status` tinyint NOT NULL COMMENT '状态',
  `remark` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '备注',
  `creator` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT '' COMMENT '创建者',
  `create_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  ...
  `deleted` bit(1) NOT NULL DEFAULT b'0' COMMENT '是否删除',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=135 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='站内信模板表';
...
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='OAuth2 客户端表';
...
CREATE TABLE IF NOT EXISTS `system_post` (
  ...
  `tenant_id` bigint NOT NULL DEFAULT '0' COMMENT '租户编号',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=2031 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='岗位信息表';
...
CREATE TABLE IF NOT EXISTS `system_role` (
  ...
  `tenant_id` bigint NOT NULL DEFAULT '0' COMMENT '租户编号',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=4210 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='角色信息表';
...
) ENGINE=InnoDB AUTO_INCREMENT=9592 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='角色和菜单关联表';
...
CREATE TABLE IF NOT EXISTS `system_user_post` (
  ...
  `tenant_id` bigint NOT NULL DEFAULT '0' COMMENT '租户编号',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='用户岗位表';
...
CREATE TABLE IF NOT EXISTS `system_user_role` (
  ...
  PRIMARY KEY (`id`) USING BTREE,
  KEY `idx_user_id` (`user_id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='用户和角色关联表';
...
CREATE TABLE IF NOT EXISTS `system_users` (
  ...
  `unique_mobile` varchar(11) COLLATE utf8mb4_unicode_ci GENERATED ALWAYS AS (nullif(`mobile`,_utf8mb4'')) STORED COMMENT '租户内非空手机号唯一值',
  `wecom_user_id` varchar(64) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '企业微信 userid',
  `unique_wecom_user_id` varchar(64) COLLATE utf8mb4_unicode_ci GENERATED ALWAYS AS (nullif(trim(`wecom_user_id`),_utf8mb4'')) STORED COMMENT '租户内非空企业微信 userid 唯一值',
  `wecom_enabled` bit(1) NOT NULL DEFAULT b'0' COMMENT '是否接收企业微信推送',
...
-- zsjos_account_stage_log
CREATE TABLE IF NOT EXISTS `zsjos_account_stage_log` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `account_id` bigint NOT NULL,
  `from_stage` varchar(24) COLLATE utf8mb4_unicode_ci NOT NULL,
  `to_stage` varchar(24) COLLATE utf8mb4_unicode_ci NOT NULL,
  `stage_version` varchar(24) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `direction` varchar(24) COLLATE utf8mb4_unicode_ci NOT NULL,
  `criteria_snapshot_json` json NOT NULL,
  `judgment_basis` varchar(2000) COLLATE utf8mb4_unicode_ci NOT NULL,
  `judged_by_user_id` bigint NOT NULL,
...
-- zsjos_advanced_filter_template
CREATE TABLE IF NOT EXISTS `zsjos_advanced_filter_template` (
  `id` bigint NOT NULL AUTO_INCREMENT COMMENT '高级筛选模板编号',
  `scene` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '高级筛选场景',
  `page_key` varchar(96) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '页面标识',
  `scope` varchar(16) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '模板范围：personal 或 system',
  `owner_user_id` bigint DEFAULT NULL COMMENT '个人模板所属用户；系统预置为空',
  `name` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '模板名称',
...
CREATE TABLE IF NOT EXISTS `zsjos_business_audit_log` (
  ...
  `operator_role_snapshot` varchar(500) COLLATE utf8mb4_unicode_ci NOT NULL,
  `category_code` varchar(64) COLLATE utf8mb4_unicode_ci NOT NULL,
  `action_code` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL,
  `target_type` varchar(64) COLLATE utf8mb4_unicode_ci NOT NULL,
  `target_id` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '公开业务编号；不可安全解析时为空',
  `detail_json` varchar(2000) COLLATE utf8mb4_unicode_ci NOT NULL,
  `source_ip` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `source_type` varchar(32) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'EXPLICIT',
  ...
  `result_status` varchar(16) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'SUCCESS',
  ...
  `tenant_id` bigint NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
  KEY `idx_category_action_time` (`tenant_id`,`category_code`,`action_code`,`occurred_at`),
...
CREATE TABLE IF NOT EXISTS `zsjos_business_event` (
  ...
  `aggregate_type` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '聚合类型',
  ...
  `to_status` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '变更后状态',
  `reason` varchar(1000) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '原因',
...
CREATE TABLE IF NOT EXISTS `zsjos_business_task` (
  ...
  `biz_type` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '业务对象类型',
  ...
  `assignee_type` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '处理人类型',
  `assignee_id` bigint NOT NULL COMMENT '处理人编号',
  `title_snapshot` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '稳定标题摘要',
  `summary_snapshot` varchar(1000) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '稳定内容摘要',
  `action_code` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '受控前端动作编码',
  ...
  `cancel_reason` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '关闭原因',
  `payload` json DEFAULT NULL COMMENT '任务业务负载',
  `idempotency_key` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '可选幂等键',
  `version` int NOT NULL DEFAULT '0' COMMENT '乐观锁版本',
  `creator` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT '' COMMENT '创建者',
  `create_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `updater` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT '' COMMENT '更新者',
  ...
  KEY `idx_tenant_assignee_status_due_v2` (`tenant_id`,`assignee_id`,`status`,`due_at`,`id`),
  KEY `idx_tenant_assignee_status_updated` (`tenant_id`,`assignee_id`,`status`,`update_time`,`id`),
...
CREATE TABLE IF NOT EXISTS `zsjos_business_task_notify_stage` (
  ...
  `notify_rule_id` bigint NOT NULL,
  ...
  `tenant_id` bigint NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
  UNIQUE KEY `uk_tenant_task_version_stage` (`tenant_id`,`task_id`,`task_version`,`stage`),
...
CREATE TABLE IF NOT EXISTS `zsjos_cashback` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `cashback_no` varchar(32) COLLATE utf8mb4_unicode_ci NOT NULL,
  ...
  `product_ref_snapshot` varchar(128) COLLATE utf8mb4_unicode_ci NOT NULL,
  `product_name_snapshot` varchar(200) COLLATE utf8mb4_unicode_ci NOT NULL,
  `rule_snapshot_json` varchar(2000) COLLATE utf8mb4_unicode_ci NOT NULL,
  `base_amount` decimal(12,2) DEFAULT NULL,
  `rate_snapshot` decimal(8,4) DEFAULT NULL,
  `amount` decimal(12,2) NOT NULL,
  `observation_days_snapshot` int NOT NULL,
  ...
  `tenant_id` bigint NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
  UNIQUE KEY `uk_tenant_cashback_no` (`tenant_id`,`cashback_no`),
  UNIQUE KEY `uk_tenant_business_key` (`tenant_id`,`business_key`),
  KEY `idx_beneficiary_status` (`tenant_id`,`beneficiary_user_id`,`status`,`generated_at`),
  KEY `idx_settlement` (`tenant_id`,`status`,`available_at`),
...
CREATE TABLE IF NOT EXISTS `zsjos_content` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `content_no` varchar(64) COLLATE utf8mb4_unicode_ci NOT NULL,
  `account_id` bigint NOT NULL,
  `production_ticket_id` bigint DEFAULT NULL,
  `title` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `topic` varchar(1000) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `module_value` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `module_label_snapshot` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `content_class_value` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL,
  `content_class_label_snapshot` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL,
  ...
  `problem_codes_json` json DEFAULT NULL,
  `published_url` varchar(1024) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `tenant_id` bigint NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `uk_tenant_content_no` (`tenant_id`,`content_no`,`deleted`),
...
-- zsjos_content_version
CREATE TABLE IF NOT EXISTS `zsjos_content_version` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `content_id` bigint NOT NULL,
  `version_no` int NOT NULL,
  `stage` varchar(24) COLLATE utf8mb4_unicode_ci NOT NULL,
  `material_refs_json` json DEFAULT NULL,
  `deliverable_url` varchar(1024) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `script_text` mediumtext COLLATE utf8mb4_unicode_ci,
  `submitted_by_user_id` bigint NOT NULL,
  `submitted_at` datetime NOT NULL,
  `review_decision` varchar(24) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `review_comment` varchar(2000) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `tenant_id` bigint NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `uk_tenant_content_version` (`tenant_id`,`content_id`,`version_no`,`deleted`),
...
CREATE TABLE IF NOT EXISTS `zsjos_customer_account` (
  ...
  `currency` varchar(16) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'CNY' COMMENT '币种',
...
CREATE TABLE IF NOT EXISTS `zsjos_customer_account_ledger` (
  ...
  `entry_type` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '充值、消费、退款或经审批调整，协议待确认',
  ...
  `idempotency_key` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '幂等键',
  `remark` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '说明',
  `creator` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT '' COMMENT '创建者',
  `create_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `updater` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT '' COMMENT '更新者',
  `update_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
...
CREATE TABLE IF NOT EXISTS `zsjos_director_config` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `interview_appointment_hours` int NOT NULL DEFAULT '96',
  `positioning_due_hours` int NOT NULL DEFAULT '48',
  ...
  `tenant_id` bigint NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `uk_tenant_director_config` (`tenant_id`,`deleted`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='编导时效配置';

-- zsjos_director_form_template
CREATE TABLE IF NOT EXISTS `zsjos_director_form_template` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `scene` varchar(32) COLLATE utf8mb4_unicode_ci NOT NULL,
  `template_code` varchar(64) COLLATE utf8mb4_unicode_ci NOT NULL,
  `name` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL,
  `default_template` bit(1) NOT NULL DEFAULT b'0',
  `status` varchar(24) COLLATE utf8mb4_unicode_ci NOT NULL,
  ...
  `tenant_id` bigint NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `uk_tenant_scene_code` (`tenant_id`,`scene`,`template_code`,`deleted`),
  KEY `idx_tenant_scene_default` (`tenant_id`,`scene`,`default_template`,`status`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='编导业务表单模板';

-- zsjos_director_form_template_version
CREATE TABLE IF NOT EXISTS `zsjos_director_form_template_version` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `template_id` bigint NOT NULL,
  `version_no` int NOT NULL,
  `status` varchar(24) COLLATE utf8mb4_unicode_ci NOT NULL,
  ...
  `tenant_id` bigint NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `uk_tenant_template_version` (`tenant_id`,`template_id`,`version_no`,`deleted`),
  KEY `idx_tenant_template_status` (`tenant_id`,`template_id`,`status`)
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='编导业务表单模板版本';

-- zsjos_export_task
CREATE TABLE IF NOT EXISTS `zsjos_export_task` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `task_no` varchar(32) COLLATE utf8mb4_unicode_ci NOT NULL,
  `export_type` varchar(32) COLLATE utf8mb4_unicode_ci NOT NULL,
  `status` varchar(32) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'queued/prechecking/generating/ready/failed/cancelled/expired',
  `creator_user_id` bigint NOT NULL,
  `creator_name_snapshot` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL,
  `creator_role_snapshot` varchar(500) COLLATE utf8mb4_unicode_ci NOT NULL,
  `filter_json` text COLLATE utf8mb4_unicode_ci NOT NULL,
  `permission_snapshot_json` varchar(2000) COLLATE utf8mb4_unicode_ci NOT NULL,
  `attempt_count` int NOT NULL DEFAULT '0',
  `next_attempt_at` datetime DEFAULT NULL,
  `lease_expires_at` datetime DEFAULT NULL,
  `result_file_id` bigint DEFAULT NULL,
  `result_file_name` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `result_file_size` bigint DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `zsjos_feedback` (
  ...
  `feedback_type` varchar(16) COLLATE utf8mb4_unicode_ci NOT NULL,
  `feedback_no` varchar(32) COLLATE utf8mb4_unicode_ci NOT NULL,
  `title` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `title_field_key` varchar(64) COLLATE utf8mb4_unicode_ci NOT NULL,
  `form_id` bigint NOT NULL,
  `form_snapshot_json` longtext COLLATE utf8mb4_unicode_ci NOT NULL,
  `value_snapshot_json` longtext COLLATE utf8mb4_unicode_ci NOT NULL,
  `support_dict_type` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `support_type_value` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `support_type_label_snapshot` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `status` varchar(24) COLLATE utf8mb4_unicode_ci NOT NULL,
  `submitter_subject_type` varchar(32) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'ADMIN' COMMENT '提交主体类型',
  `submitter_user_id` bigint NOT NULL,
  `submitter_name_snapshot` varchar(128) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `partner_id` bigint DEFAULT NULL COMMENT '合作方主体编号',
  `assignee_user_id` bigint DEFAULT NULL,
  `assignee_name_snapshot` varchar(128) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `last_reply_summary` varchar(500) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `last_activity_at` datetime NOT NULL,
  `unread_for_submitter` bit(1) NOT NULL DEFAULT b'0',
  `unread_for_assignee` bit(1) NOT NULL DEFAULT b'0',
  `approval_enabled` bit(1) NOT NULL DEFAULT b'0',
  `process_instance_id` varchar(64) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `approval_round_no` int NOT NULL DEFAULT '0',
  `reject_reason` varchar(1000) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `completed_result` text COLLATE utf8mb4_unicode_ci,
  `result_attachment_ids_json` json DEFAULT NULL,
  ...
  KEY `idx_submitter_subject_activity` (`tenant_id`,`submitter_subject_type`,`submitter_user_id`,`deleted`,`last_activity_at`),
  KEY `idx_feedback_partner` (`tenant_id`,`partner_id`,`deleted`),
...
CREATE TABLE IF NOT EXISTS `zsjos_feedback_config` (
  ...
  `form_id` bigint NOT NULL,
  `title_field_key` varchar(64) COLLATE utf8mb4_unicode_ci NOT NULL,
  `dispatcher_user_ids_json` json NOT NULL,
  `approval_enabled` bit(1) NOT NULL DEFAULT b'0',
  `bpm_process_definition_key` varchar(128) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `last_idempotency_key` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL,
  `last_request_fingerprint` varchar(64) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `version` int NOT NULL DEFAULT '0',
  `creator` varchar(64) COLLATE utf8mb4_unicode_ci DEFAULT '',
  `create_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `updater` varchar(64) COLLATE utf8mb4_unicode_ci DEFAULT '',
...
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='反馈设置';

-- zsjos_feedback_no_daily_counter
...
-- zsjos_feedback_reply
CREATE TABLE IF NOT EXISTS `zsjos_feedback_reply` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `tenant_id` bigint NOT NULL DEFAULT '0',
  `feedback_id` bigint NOT NULL,
  `author_user_id` bigint NOT NULL,
  `author_name_snapshot` varchar(128) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `author_type` varchar(16) COLLATE utf8mb4_unicode_ci NOT NULL,
  `content` text COLLATE utf8mb4_unicode_ci NOT NULL,
  `attachment_ids_json` json DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `zsjos_feedback_round` (
  ...
  `form_snapshot_json` longtext COLLATE utf8mb4_unicode_ci NOT NULL,
  `value_snapshot_json` longtext COLLATE utf8mb4_unicode_ci NOT NULL,
  `approval_context_json` longtext COLLATE utf8mb4_unicode_ci NOT NULL,
  `process_instance_id` varchar(64) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `business_key` varchar(180) COLLATE utf8mb4_unicode_ci NOT NULL,
  `reject_reason` varchar(1000) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `submitted_at` datetime NOT NULL,
  `creator` varchar(64) COLLATE utf8mb4_unicode_ci DEFAULT '',
  `create_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE IF NOT EXISTS `zsjos_feedback_survey` (
  ...
  `form_id` bigint NOT NULL,
  `form_snapshot_json` longtext COLLATE utf8mb4_unicode_ci NOT NULL,
  `value_snapshot_json` longtext COLLATE utf8mb4_unicode_ci,
  `requested_by_user_id` bigint NOT NULL,
  `requested_by_name_snapshot` varchar(128) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `zsjos_forced_form` (
  ...
  KEY `idx_tenant_current_version` (`tenant_id`,`current_version_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='ZSJOS强制表单';

-- zsjos_forced_form_batch
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='ZSJOS强制表单发送批次';

-- zsjos_forced_form_recipient
CREATE TABLE IF NOT EXISTS `zsjos_forced_form_recipient` (
  ...
  `form_id` bigint NOT NULL,
  `user_id` bigint NOT NULL,
  `nickname_snapshot` varchar(128) DEFAULT NULL COMMENT '用户昵称快照',
  `dept_snapshot` varchar(255) DEFAULT NULL COMMENT '部门快照',
  `post_snapshot` varchar(255) DEFAULT NULL COMMENT '岗位快照',
  ...
  `deleted` bit(1) NOT NULL DEFAULT b'0',
  PRIMARY KEY (`id`),
  UNIQUE KEY `uk_tenant_form_user` (`tenant_id`,`form_id`,`user_id`),
  KEY `idx_user_status` (`tenant_id`,`user_id`,`status`),
  KEY `idx_tenant_form_status` (`tenant_id`,`form_id`,`status`),
  KEY `idx_tenant_batch` (`tenant_id`,`batch_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='ZSJOS强制表单接收人';

-- zsjos_forced_form_submission
CREATE TABLE IF NOT EXISTS `zsjos_forced_form_submission` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `tenant_id` bigint NOT NULL DEFAULT '0',
  `form_id` bigint NOT NULL,
  `version_id` bigint DEFAULT NULL COMMENT '提交版本ID',
  `user_id` bigint NOT NULL,
  `fields_snapshot_json` text NOT NULL,
  `answers_json` text NOT NULL,
  `dict_snapshot_json` text,
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `uk_tenant_form_user` (`tenant_id`,`form_id`,`user_id`),
  KEY `idx_form_time` (`tenant_id`,`form_id`,`create_time`),
  KEY `idx_tenant_user_time` (`tenant_id`,`user_id`,`create_time`),
  KEY `idx_tenant_version` (`tenant_id`,`version_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='ZSJOS强制表单提交';

-- zsjos_forced_form_submission_file
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='ZSJOS强制表单提交附件';

-- zsjos_forced_form_version
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='ZSJOS强制表单版本';

-- zsjos_impersonation_request_log
CREATE TABLE IF NOT EXISTS `zsjos_impersonation_request_log` (
  ...
  `tenant_id` bigint NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
  KEY `idx_session_time` (`tenant_id`,`session_id`,`occurred_at`)
...
CREATE TABLE IF NOT EXISTS `zsjos_impersonation_session` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `administrator_user_id` bigint NOT NULL,
  `administrator_name_snapshot` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL,
  `target_user_id` bigint NOT NULL,
  `target_name_snapshot` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL,
  `reason` varchar(500) COLLATE utf8mb4_unicode_ci NOT NULL,
  `status` varchar(20) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'active/ended/expired',
  `started_at` datetime NOT NULL,
  `last_active_at` datetime NOT NULL,
  `ended_at` datetime DEFAULT NULL,
  `ended_reason` varchar(500) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `version` int NOT NULL DEFAULT '0',
  `creator` varchar(64) COLLATE utf8mb4_unicode_ci DEFAULT '',
  `create_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `updater` varchar(64) COLLATE utf8mb4_unicode_ci DEFAULT '',
  ...
  `tenant_id` bigint NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
  KEY `idx_admin_status` (`tenant_id`,`administrator_user_id`,`status`),
...
-- zsjos_interview_record
CREATE TABLE IF NOT EXISTS `zsjos_interview_record` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `account_id` bigint NOT NULL,
  `student_person_id` bigint DEFAULT NULL,
  `director_user_id` bigint NOT NULL,
  `structured_content_json` json DEFAULT NULL,
  `raw_import_text` mediumtext COLLATE utf8mb4_unicode_ci,
  `import_source` varchar(24) COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE IF NOT EXISTS `zsjos_lead` (
  ...
  `lead_no` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '客资业务编号',
  `person_id` bigint NOT NULL COMMENT 'Person 编号',
  `submitted_name` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '表单原始姓名',
  `submitted_mobile` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '表单原始手机号',
  `submitted_wechat_id` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '表单原始微信号',
  `source_type` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '客资来源类型',
  `source_user_id` bigint DEFAULT NULL COMMENT '内部提交员工用户编号',
  `source_provider_user_id` bigint DEFAULT NULL COMMENT '销售自拓时关联的新媒体提供方用户编号',
  ...
  `partner_owner_name_snapshot` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '兼职提交时归属员工姓名快照',
  `provider_owner_type` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '规范提供方类型 system_user/partner',
  `provider_owner_id` bigint DEFAULT NULL COMMENT '规范提供方内部ID',
  `provider_owner_name_snapshot` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '首次计数时提供方名称快照',
  `contribution_user_id_snapshot` bigint DEFAULT NULL COMMENT '首次计数时业绩员工ID快照',
  `contribution_user_name_snapshot` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '首次计数时业绩员工姓名快照',
  `contribution_supervisor_user_id_snapshot` bigint DEFAULT NULL COMMENT '首次计数时直属主管ID快照',
  `contribution_supervisor_name_snapshot` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '首次计数时直属主管姓名快照',
  `contribution_dept_id_snapshot` bigint DEFAULT NULL COMMENT '首次计数时业绩部门ID快照',
  `contribution_dept_name_snapshot` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '首次计数时业绩部门名称快照',
  `source_channel_id` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '来源渠道编号',
  `source_channel_label_snapshot` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '来源渠道选择时标签快照',
  `status` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '客资主状态',
  `assignment_status` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '客资分配状态',
  ...
  `no_progress_warned_at` datetime DEFAULT NULL COMMENT '无进展预警时间',
  ...
  `valid_description` varchar(2000) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '有效判定备注',
  ...
  `invalid_reason` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '无效原因',
  `invalid_reason_label_snapshot` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '无效原因标签快照',
  `invalid_description` varchar(2000) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '无效判定说明',
  `invalid_evidence_refs` json DEFAULT NULL COMMENT '无效判定图片引用',
  `appeal_deadline_at` datetime DEFAULT NULL COMMENT '申诉截止时间',
  `closed_at` datetime DEFAULT NULL COMMENT '关闭时间',
  `close_reason` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '关闭原因',
  `version` int NOT NULL DEFAULT '0' COMMENT '乐观锁版本',
  `creator` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT '' COMMENT '创建者',
  `create_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `updater` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT '' COMMENT '更新者',
  ...
  `deleted` bit(1) NOT NULL DEFAULT b'0' COMMENT '是否删除',
  `tenant_id` bigint NOT NULL DEFAULT '0' COMMENT '租户编号',
  `province_code` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '提交时省级地区编码，OTHER 表示其他',
  `province_name` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '提交时省级地区名称快照',
  `city_code` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '提交时市级地区编码，OTHER 表示其他',
  `city_name` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '提交时市级地区名称快照',
  `lead_category` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '客资分类字典值',
  `lead_category_label_snapshot` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '客资分类选择时标签快照',
  `remark` varchar(1000) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '提交备注',
  `dispatch_mode` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '派单模式：auto 或 specified',
  ...
  `submission_idempotency_key` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '提交幂等键',
  `active_person_id` bigint GENERATED ALWAYS AS ((case when (`deleted` = 0x00) then `person_id` else NULL end)) STORED COMMENT '活动客户主客资唯一键',
  PRIMARY KEY (`id`),
...
CREATE TABLE IF NOT EXISTS `zsjos_lead_aging_pool_cycle` (
  ...
  `original_owner_user_id` bigint NOT NULL,
  `collaborator_user_id` bigint DEFAULT NULL,
  `frozen_dept_id` bigint NOT NULL,
  `status` varchar(32) COLLATE utf8mb4_unicode_ci NOT NULL,
  `ownership_started_at` datetime NOT NULL,
  ...
  `tenant_id` bigint NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
  UNIQUE KEY `uk_tenant_lead_cycle` (`tenant_id`,`lead_id`,`cycle_no`),
  UNIQUE KEY `uk_tenant_idempotency` (`tenant_id`,`idempotency_key`),
...
CREATE TABLE IF NOT EXISTS `zsjos_lead_aging_pool_event` (
  ...
  `operator_user_id` bigint DEFAULT NULL,
  `previous_collaborator_user_id` bigint DEFAULT NULL,
  `collaborator_user_id` bigint DEFAULT NULL,
...
-- zsjos_lead_aging_pool_notify_stage
CREATE TABLE IF NOT EXISTS `zsjos_lead_aging_pool_notify_stage` (
  ...
  `tenant_id` bigint NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
  UNIQUE KEY `uk_tenant_lead_cycle_rule` (`tenant_id`,`lead_id`,`cycle_no`,`notify_rule_id`),
...
CREATE TABLE IF NOT EXISTS `zsjos_lead_appeal` (
  ...
  `review_stage` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '审核阶段',
  `status` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '申诉状态',
  ...
  `reason` varchar(1000) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '申诉原因',
  `evidence_refs` json DEFAULT NULL COMMENT '证据引用',
  `invalid_reason_snapshot` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '无效原因快照',
  `invalid_description_snapshot` varchar(2000) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '无效说明快照',
  `invalid_evidence_refs_snapshot` json DEFAULT NULL COMMENT '无效判定图片快照',
  `process_instance_id` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'BPM 流程实例编号',
  `reviewer_user_id` bigint DEFAULT NULL COMMENT '复核人用户编号',
  `decision_reason` varchar(1000) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '决定原因',
  `decision_evidence_refs` json DEFAULT NULL COMMENT '裁决图片引用',
  `submitted_at` datetime NOT NULL COMMENT '提交时间',
  `decided_at` datetime DEFAULT NULL COMMENT '决定时间',
  `submission_idempotency_key` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '提交幂等键',
  `decision_idempotency_key` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '裁决幂等键',
  `creator` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT '' COMMENT '创建者',
  `create_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `updater` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT '' COMMENT '更新者',
  `update_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
...
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='ZSJOS 全局轮询派单游标';
...
CREATE TABLE IF NOT EXISTS `zsjos_lead_assignment_history` (
  ...
  `lead_id` bigint NOT NULL COMMENT '客资编号',
  `action_type` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '派单、接单、拒单、转派、回收、释放或认领',
  ...
  `reason` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '原因',
  `occurred_at` datetime NOT NULL COMMENT '实际发生时间',
  `creator` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT '' COMMENT '创建者',
  `create_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `updater` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT '' COMMENT '更新者',
...
CREATE TABLE IF NOT EXISTS `zsjos_lead_assignment_rule` (
  ...
  `strategy_type` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '策略类型',
...
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='ZSJOS 客资派单规则';
...
CREATE TABLE IF NOT EXISTS `zsjos_lead_attachment` (
  ...
  `file_url` varchar(1024) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '历史 Infra 文件访问地址；新数据使用 infra_file_id',
  `original_name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '原文件名',
  `content_type` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'MIME 类型',
...
CREATE TABLE IF NOT EXISTS `zsjos_lead_complaint` (
  ...
  `handler_opinion` varchar(1000) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `handler_evidence_refs` json DEFAULT NULL,
  `handled_at` datetime DEFAULT NULL,
  `create_idempotency_key` varchar(128) COLLATE utf8mb4_unicode_ci NOT NULL,
  `decision_idempotency_key` varchar(128) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `version` int NOT NULL DEFAULT '0',
  `creator` varchar(64) COLLATE utf8mb4_unicode_ci DEFAULT '',
  `create_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `updater` varchar(64) COLLATE utf8mb4_unicode_ci DEFAULT '',
...
CREATE TABLE IF NOT EXISTS `zsjos_lead_duplicate_review` (
  ...
  `submission_source_type` varchar(32) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `submission_partner_id` bigint DEFAULT NULL,
  `submission_snapshot` json NOT NULL,
  `lead_category_label_snapshot` varchar(128) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `source_channel_label_snapshot` varchar(128) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `duplicate_flag` varchar(32) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `duplicate_result` varchar(32) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `primary_rule_code` varchar(64) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `review_fingerprint` varchar(64) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `match_rules` json NOT NULL,
  `candidate_snapshot` json NOT NULL,
  `matched_person_id` bigint DEFAULT NULL,
  `matched_lead_id` bigint DEFAULT NULL,
  `result_type` varchar(32) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `review_opinion` varchar(2000) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `review_attachments` json DEFAULT NULL,
  `selected_sales_user_id` bigint DEFAULT NULL,
  `reviewer_user_id` bigint DEFAULT NULL,
  `reviewed_at` datetime DEFAULT NULL,
  `before_snapshot` json DEFAULT NULL,
  `after_snapshot` json DEFAULT NULL,
  `submission_idempotency_key` varchar(128) COLLATE utf8mb4_unicode_ci NOT NULL,
  `decision_idempotency_key` varchar(128) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `version` int NOT NULL DEFAULT '0',
  `creator` varchar(64) COLLATE utf8mb4_unicode_ci DEFAULT '',
  `create_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  ...
  KEY `idx_tenant_duplicate_pending` (`tenant_id`,`status`,`review_fingerprint`),
...
CREATE TABLE IF NOT EXISTS `zsjos_lead_follow_up_record` (
  ...
  `method_value` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `method_label_snapshot` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `result_value` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `result_label_snapshot` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `category_before` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `category_before_label_snapshot` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `category_after` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `category_after_label_snapshot` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `remark` varchar(2000) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `zsjos_lead_follow_up_rule` (
  ...
  `no_progress_warning_days` int NOT NULL DEFAULT '7' COMMENT '判定前无进展预警天数',
  `no_progress_grace_days` int NOT NULL DEFAULT '2' COMMENT '无进展预警宽限天数',
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `uk_tenant_code` (`tenant_id`,`code`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='ZSJOS 客资跟进时效规则';
...
CREATE TABLE IF NOT EXISTS `zsjos_lead_inbox_filter_scheme` (
  ...
  `audience` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '适用视角：submitter、owner、reviewer 或 agingPool',
...
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='ZSJOS 客资收件箱筛选方案';
...
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='ZSJOS 客资收件箱筛选发布版本';
...
CREATE TABLE IF NOT EXISTS `zsjos_lead_intended_product` (
  ...
  `lead_id` bigint NOT NULL COMMENT '客资编号',
  `product_ref` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '兼容 SPU 稳定引用，未明确课程时为空',
  `product_name_snapshot` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '提交时产品名称快照',
  ...
  `level1_category_name_snapshot` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `level2_category_id` bigint DEFAULT NULL,
  `level2_category_name_snapshot` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `spu_ref` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `spu_name_snapshot` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `sku_ref` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `sku_name_snapshot` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `category_name_snapshot` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '提交时叶子分类名称快照',
  `category_path_snapshot` json DEFAULT NULL COMMENT '提交时完整分类路径快照',
  `active_product_ref` varchar(128) COLLATE utf8mb4_unicode_ci GENERATED ALWAYS AS (if((`deleted` = 0),`product_ref`,NULL)) STORED,
  PRIMARY KEY (`id`),
...
CREATE TABLE IF NOT EXISTS `zsjos_lead_public_sea_record` (
  ...
  `release_reason` varchar(500) COLLATE utf8mb4_unicode_ci NOT NULL,
  `creator` varchar(64) COLLATE utf8mb4_unicode_ci DEFAULT '',
  `create_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `updater` varchar(64) COLLATE utf8mb4_unicode_ci DEFAULT '',
  `update_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  ...
  `tenant_id` bigint NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
  UNIQUE KEY `uk_tenant_lead` (`tenant_id`,`lead_id`),
...
-- zsjos_lead_submitter_assist_request
CREATE TABLE IF NOT EXISTS `zsjos_lead_submitter_assist_request` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `lead_id` bigint NOT NULL,
  `lead_no_snapshot` varchar(64) COLLATE utf8mb4_unicode_ci NOT NULL,
  `requester_user_id` bigint NOT NULL,
  `problem` varchar(1000) COLLATE utf8mb4_unicode_ci NOT NULL,
  `expected_assistance` varchar(1000) COLLATE utf8mb4_unicode_ci NOT NULL,
  `remark` varchar(2000) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `attachment_snapshots_json` json DEFAULT NULL,
  `submitter_type_snapshot` varchar(32) COLLATE utf8mb4_unicode_ci NOT NULL,
  `submitter_id_snapshot` bigint NOT NULL,
  `submitter_name_snapshot` varchar(128) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `assignee_user_id_snapshot` bigint DEFAULT NULL,
  `assignee_name_snapshot` varchar(128) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `requested_at` datetime NOT NULL,
...
CREATE TABLE IF NOT EXISTS `zsjos_lead_transfer_request` (
  ...
  `transfer_reviewer_user_id` bigint DEFAULT NULL COMMENT '提交时主管快照',
  `reason` varchar(500) COLLATE utf8mb4_unicode_ci NOT NULL,
  `status` varchar(32) COLLATE utf8mb4_unicode_ci NOT NULL,
  `process_instance_id` varchar(64) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `idempotency_key` varchar(64) COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE IF NOT EXISTS `zsjos_lead_urge` (
  ...
  KEY `idx_tenant_partner` (`tenant_id`,`partner_id`,`urged_at`)
...
CREATE TABLE IF NOT EXISTS `zsjos_media_account` (
  ...
  `account_type_primary_value` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `account_type_primary_label_snapshot` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `account_type_secondary_value` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `account_type_secondary_label_snapshot` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `track_primary_value` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `track_primary_label_snapshot` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `track_secondary_value` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `track_secondary_label_snapshot` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `lead_direction` varchar(500) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `current_status_value` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '当下状态字典值',
  `current_status_label_snapshot` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '当下状态标签快照',
  `s_stage` varchar(24) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `s_stage_label_snapshot` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '阶段标签快照',
  `primary_problems_json` json DEFAULT NULL COMMENT '主要问题值与标签快照',
  `execution_measure_value` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '实行措施字典值',
  `execution_measure_label_snapshot` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '实行措施标签快照',
  `adjustment_direction` varchar(1000) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '修改方向',
  `maintenance_start_date` date DEFAULT NULL COMMENT '维护区间开始日期',
  `maintenance_end_date` date DEFAULT NULL COMMENT '维护区间结束日期',
  `s_stage_version` varchar(24) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `s_stage_entered_at` datetime DEFAULT NULL,
  `s_stage_judged_by_user_id` bigint DEFAULT NULL,
  `is_silent` bit(1) NOT NULL DEFAULT b'0',
  `coop_level_value` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `coop_level_label_snapshot` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `account_grade_value` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `account_grade_label_snapshot` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `health_status_value` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `health_status_label_snapshot` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `primary_problem_code_value` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `primary_problem_code_label_snapshot` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `secondary_problem_code_value` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `secondary_problem_code_label_snapshot` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `run_status` varchar(24) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'active',
  `rescue_status` varchar(24) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'none',
  `whitelist_status` varchar(24) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'none',
  `positioning_card_id` bigint DEFAULT NULL,
  `content_model_json` json DEFAULT NULL,
  `health_json` json DEFAULT NULL,
  `risk_level_value` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `risk_level_label_snapshot` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `rebind_process_instance_id` varchar(64) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `rebind_target_student_person_id` bigint DEFAULT NULL,
  `rebind_requested_by_user_id` bigint DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `zsjos_media_account_field_config` (
  ...
  `tenant_id` bigint NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `uk_media_account_field_version` (`tenant_id`,`version_no`,`deleted`),
  KEY `idx_media_account_field_status` (`tenant_id`,`status`,`version_no`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='第三方账号详情字段配置版本';

-- zsjos_media_account_maintenance_revision
CREATE TABLE IF NOT EXISTS `zsjos_media_account_maintenance_revision` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `account_id` bigint NOT NULL,
  `revision_no` int NOT NULL,
  `current_status_value` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `current_status_label_snapshot` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `stage_value` varchar(24) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `stage_label_snapshot` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `primary_problems_json` json DEFAULT NULL,
  `execution_measure_value` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `execution_measure_label_snapshot` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `adjustment_direction` varchar(1000) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
-- zsjos_media_account_no_daily_counter
CREATE TABLE IF NOT EXISTS `zsjos_media_account_no_daily_counter` (
  ...
  `tenant_id` bigint NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `uk_tenant_sequence_date` (`tenant_id`,`sequence_date`,`deleted`)
...
CREATE TABLE IF NOT EXISTS `zsjos_media_account_student_link` (
  ...
  `tenant_id` bigint NOT NULL,
  PRIMARY KEY (`id`),
  KEY `idx_tenant_account_started` (`tenant_id`,`account_id`,`started_at`),
...
-- zsjos_media_config_version
CREATE TABLE IF NOT EXISTS `zsjos_media_config_version` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `version_no` int NOT NULL,
  `status` varchar(24) COLLATE utf8mb4_unicode_ci NOT NULL,
  `approval_config_json` json NOT NULL,
  `stage_checklist_json` json NOT NULL,
  `threshold_config_json` json NOT NULL,
  `account_grade_rules_json` json NOT NULL,
  `published_at` datetime DEFAULT NULL,
  `version` int NOT NULL DEFAULT '0',
  `creator` varchar(64) COLLATE utf8mb4_unicode_ci DEFAULT '',
  `create_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  ...
  `tenant_id` bigint NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `uk_tenant_version_no` (`tenant_id`,`version_no`,`deleted`),
  KEY `idx_tenant_status` (`tenant_id`,`status`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='新媒体工作流配置版本';

-- zsjos_media_screen_daily_snapshot
CREATE TABLE IF NOT EXISTS `zsjos_media_screen_daily_snapshot` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `snapshot_date` date NOT NULL,
  `contribution_type` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'direct/part_time',
  ...
  `supervisor_name` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `tenant_id` bigint NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `uk_tenant_snapshot_contributor` (`tenant_id`,`snapshot_date`,`contribution_type`,`department_id`,`member_id`),
...
-- zsjos_media_student_talk_record
CREATE TABLE IF NOT EXISTS `zsjos_media_student_talk_record` (
  ...
  `tenant_id` bigint NOT NULL,
  PRIMARY KEY (`id`),
  KEY `idx_media_student_talk` (`tenant_id`,`student_person_id`,`occurred_at`,`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='编导及运营学员交谈记录';
...
CREATE TABLE IF NOT EXISTS `zsjos_module_schema_version` (
  ...
  `version` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '迁移版本',
  `description` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '迁移说明',
  `checksum` char(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '迁移文件 SHA-256',
  `release_version` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '发行版本',
...
CREATE TABLE IF NOT EXISTS `zsjos_opportunity` (
  ...
  `person_id` bigint NOT NULL COMMENT 'Person 编号',
  `type` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '阶段一仅使用 initial_conversion',
  ...
  `status` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '机会状态',
  ...
  `shelved_reason` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '暂缓原因',
  `won_at` datetime DEFAULT NULL COMMENT '成交时间',
  `lost_at` datetime DEFAULT NULL COMMENT '流失时间',
  `lost_reason` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '流失原因',
  `version` int NOT NULL DEFAULT '0' COMMENT '乐观锁版本',
  `creator` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT '' COMMENT '创建者',
  `create_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `updater` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT '' COMMENT '更新者',
  ...
  `deleted` bit(1) NOT NULL DEFAULT b'0' COMMENT '是否删除',
  `tenant_id` bigint NOT NULL DEFAULT '0' COMMENT '租户编号',
  `active_person_id` bigint GENERATED ALWAYS AS ((case when (`deleted` = 0x00) then `person_id` else NULL end)) STORED COMMENT '活动客户商机唯一键',
  PRIMARY KEY (`id`),
...
CREATE TABLE IF NOT EXISTS `zsjos_order` (
  `id` bigint NOT NULL AUTO_INCREMENT COMMENT '订单编号',
  `order_no` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '订单业务编号',
  ...
  `person_id` bigint NOT NULL COMMENT 'Person 编号',
  `order_type` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '订单业务类型，具体协议待确认',
  `status` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '订单状态',
  `submitter_user_id` bigint DEFAULT NULL COMMENT '本次订单提交人',
  `formal_sales_user_id` bigint DEFAULT NULL COMMENT '正式销售归属',
  `submitter_center_type` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '提交中心类型',
  `buyer_name` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '购买方快照',
  `student_name` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '学员姓名快照',
  `student_nature` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '学员性质字典值',
  `student_mobile` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '学员手机号快照',
  `student_wechat_id` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '学员微信号快照',
  `province_code` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '省编码快照',
  `province_name` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '省名称快照',
  `city_code` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '市编码快照',
  `city_name` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '市名称快照',
  `agreed_exam_time` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '商定考试时间文本',
  `class_type` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '开通班种文本',
  `service_period` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '服务周期字典值',
  `student_source` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '学生来源字典值',
  ...
  `fee_mode` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '缴费方式字典值',
  `payment_method` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '支付方式字典值',
  `remark` varchar(1000) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '订单备注',
  `student_special_requirements` varchar(1000) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '学生特殊要求',
  `material_delivery_contact` varchar(1000) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '教材邮递联系',
  `payment_voucher_refs` json DEFAULT NULL COMMENT '缴费凭证文件快照',
  `submission_idempotency_key` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '首次提交幂等键',
  `submission_request_fingerprint` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '规范化提交请求指纹',
  `repurchase_reason` varchar(1000) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '复购说明',
  `termination_reason` varchar(1000) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '终止原因',
  ...
  `zero_amount_reason` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '零元订单原因',
  ...
  `deleted` bit(1) NOT NULL DEFAULT b'0' COMMENT '是否删除',
  `tenant_id` bigint NOT NULL DEFAULT '0' COMMENT '租户编号',
  `active_lead_id` bigint GENERATED ALWAYS AS ((case when ((`deleted` = 0x00) and (`status` in (_utf8mb4'pending_approval',_utf8mb4'revision_required'))) then `lead_id` else NULL end)) STORED COMMENT '活动成交单客资唯一键',
  `active_repurchase_person_id` bigint GENERATED ALWAYS AS ((case when ((`deleted` = 0x00) and (`order_type` = _utf8mb4'repurchase') and (`status` in (_utf8mb4'pending_approval',_utf8mb4'revision_required'))) then `person_id` else NULL end)) STORED COMMENT '活动复购客户唯一键',
  PRIMARY KEY (`id`),
  ...
  UNIQUE KEY `uk_tenant_active_repurchase` (`tenant_id`,`active_repurchase_person_id`),
  KEY `idx_tenant_lead_status` (`tenant_id`,`lead_id`,`status`),
...
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='成交订单审批部门配置';
...
CREATE TABLE IF NOT EXISTS `zsjos_order_approval_round` (
  ...
  `status` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '审批轮次状态',
  `order_snapshot` json NOT NULL COMMENT '本轮订单完整快照',
  `process_instance_id` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'BPM 流程实例编号',
  `process_definition_key` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'BPM 流程定义 Key',
  ...
  `rejected_bpm_task_id` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '驳回任务引用，由 BPM 任务事件提供',
  `decision_reason` varchar(1000) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '本轮最终非通过原因快照',
  `submission_idempotency_key` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '本轮提交幂等键',
  `registration_decision_idempotency_key` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '报名履约决策幂等键',
  `finance_decision_idempotency_key` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '财务决策幂等键',
  `termination_idempotency_key` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '终止幂等键',
  ...
  UNIQUE KEY `uk_tenant_registration_decision_key` (`tenant_id`,`registration_decision_idempotency_key`),
...
CREATE TABLE IF NOT EXISTS `zsjos_order_command` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `idempotency_key` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '客户端命令幂等键',
  `order_id` bigint NOT NULL COMMENT '订单编号',
  `approval_round_id` bigint NOT NULL COMMENT '审批轮次编号',
  `process_instance_id` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'BPM 流程实例编号',
  `command_type` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'approve/reject/terminate',
  `task_definition_key` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '审批节点；终止为空',
  `bpm_task_id` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'BPM 任务编号；终止为空',
  `operator_user_id` bigint NOT NULL COMMENT '操作人用户编号',
  `request_fingerprint` char(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '规范化请求指纹',
  `creator` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT '',
  `create_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `updater` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT '',
  `update_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
...
CREATE TABLE IF NOT EXISTS `zsjos_order_item` (
  ...
  `product_ref` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '产品稳定编号快照',
  `sku_ref` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'SKU 稳定编号快照',
  ...
  `product_rule_version` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '产品规则版本',
  `creator` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT '' COMMENT '创建者',
  `create_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `updater` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT '' COMMENT '更新者',
  `update_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
...
CREATE TABLE IF NOT EXISTS `zsjos_order_no_daily_counter` (
  ...
  `tenant_id` bigint NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
  UNIQUE KEY `uk_tenant_order_no_sequence_date` (`tenant_id`,`sequence_date`)
...
CREATE TABLE IF NOT EXISTS `zsjos_order_supervisor_confirmation` (
  ...
  `order_id` bigint NOT NULL COMMENT '订单编号',
  `approval_round_id` bigint NOT NULL COMMENT '审批轮次编号',
  `task_definition_key` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '报名或财务 BPM 节点',
  `requester_user_id` bigint NOT NULL COMMENT '申请人用户编号',
  `supervisor_user_id` bigint NOT NULL COMMENT '直属部门负责人用户编号',
  `parent_task_id` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '原普通审批任务编号',
  `supervisor_task_id` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'BPM 并行加签任务编号',
  `request_reason` varchar(1000) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '申请原因',
  `decision_reason` varchar(1000) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '主管意见',
  `status` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'pending/confirmed/rejected/cancelled',
...
CREATE TABLE IF NOT EXISTS `zsjos_partner` (
  ...
  `partner_no` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '兼职主体业务编号',
  `name` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '姓名或主体名称',
  ...
  `avatar` varchar(512) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '头像地址',
  `sex` tinyint DEFAULT NULL COMMENT '性别',
  `status` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '启停状态，协议值待确认',
  `bound_system_user_id` bigint DEFAULT NULL COMMENT '绑定系统账号编号',
  `channel_id` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '渠道编号',
...
CREATE TABLE IF NOT EXISTS `zsjos_partner_account` (
  ...
  `mobile` varchar(32) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '登录手机号',
  `password` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'BCrypt 密码哈希',
...
CREATE TABLE IF NOT EXISTS `zsjos_partner_bank_card` (
  ...
  `default_card` bit(1) NOT NULL DEFAULT b'0',
  `version` int NOT NULL DEFAULT '0',
  `creator` varchar(64) COLLATE utf8mb4_unicode_ci DEFAULT '',
  `create_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `updater` varchar(64) COLLATE utf8mb4_unicode_ci DEFAULT '',
  ...
  `tenant_id` bigint NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
  KEY `idx_owner` (`tenant_id`,`owner_user_id`,`default_card`,`id`)
...
CREATE TABLE IF NOT EXISTS `zsjos_partner_invitation` (
  ...
  `invite_code` varchar(8) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '邀请码：四位大写字母加四位数字',
  `name` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '兼职姓名',
  `mobile` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '激活手机号',
  `assigned_operator_user_id` bigint NOT NULL COMMENT '归属运营用户编号',
  `assigned_operator_name_snapshot` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '归属运营姓名快照',
  `status` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '状态：active/used/voided/expired',
...
-- zsjos_partner_ownership
CREATE TABLE IF NOT EXISTS `zsjos_partner_ownership` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `partner_id` bigint NOT NULL,
  `employee_user_id` bigint NOT NULL,
  `employee_name_snapshot` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE IF NOT EXISTS `zsjos_partner_ownership_log` (
  ...
  `previous_employee_name_snapshot` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `employee_user_id` bigint DEFAULT NULL,
  `employee_name_snapshot` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `zsjos_partner_student_link` (
  ...
  `deleted` bit(1) NOT NULL DEFAULT b'0',
  `tenant_id` bigint NOT NULL,
  `active_partner_id` bigint GENERATED ALWAYS AS ((case when ((`status` = _utf8mb4'active') and (`deleted` = 0x00)) then `partner_id` else NULL end)) STORED,
  `active_student_person_id` bigint GENERATED ALWAYS AS ((case when ((`status` = _utf8mb4'active') and (`deleted` = 0x00)) then `student_person_id` else NULL end)) STORED,
  PRIMARY KEY (`id`),
  UNIQUE KEY `uk_tenant_active_partner` (`tenant_id`,`active_partner_id`),
...
CREATE TABLE IF NOT EXISTS `zsjos_payment_gateway_event` (
  ...
  `operation` varchar(32) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `direction` varchar(16) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `business_id` bigint DEFAULT NULL,
  `request_no` varchar(128) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `http_status` int DEFAULT NULL,
  `gateway_retcode` varchar(32) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `gateway_trxstatus` varchar(32) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `error_category` varchar(64) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `payload_digest` varchar(128) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `request_payload` json DEFAULT NULL,
  `response_payload` json DEFAULT NULL,
  `signature_valid` bit(1) NOT NULL DEFAULT b'0',
  `processing_result` varchar(64) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `creator` varchar(64) COLLATE utf8mb4_unicode_ci DEFAULT '',
  `create_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `updater` varchar(64) COLLATE utf8mb4_unicode_ci DEFAULT '',
  `update_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  ...
  `tenant_id` bigint NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
  UNIQUE KEY `uk_tenant_payment_event` (`tenant_id`,`event_id`),
...
CREATE TABLE IF NOT EXISTS `zsjos_payment_order` (
  ...
  `purchase_intent_id` bigint DEFAULT NULL COMMENT '购买意向编号',
  `payment_order_no` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '支付单业务编号',
  `lead_id` bigint DEFAULT NULL COMMENT '首购来源客资编号；复购可为空',
  `person_id` bigint NOT NULL COMMENT 'Person 编号',
  `opportunity_id` bigint DEFAULT NULL COMMENT '可选正式销售机会编号',
  `status` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'created/waiting/paid/expired/closed',
  `provider` varchar(32) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '支付提供方',
  `channel` varchar(32) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'wechat/alipay',
  `reqsn` varchar(64) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '通联商户订单号',
  ...
  `link_token_hash` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '支付链接令牌摘要',
  `link_url` varchar(1024) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '公开支付链接',
...
CREATE TABLE IF NOT EXISTS `zsjos_payment_refund` (
  ...
  `approval_mode` varchar(32) COLLATE utf8mb4_unicode_ci NOT NULL,
  `process_instance_id` varchar(64) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `status` varchar(32) COLLATE utf8mb4_unicode_ci NOT NULL,
  `provider` varchar(32) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'allinpay',
  `refund_reqsn` varchar(64) COLLATE utf8mb4_unicode_ci NOT NULL,
  `original_reqsn` varchar(64) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `original_trx_id` varchar(128) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  UNIQUE KEY `uk_tenant_refund_reqsn` (`tenant_id`,`refund_reqsn`),
  UNIQUE KEY `uk_tenant_refund_idem` (`tenant_id`,`idempotency_key`),
  KEY `idx_tenant_refund_reconcile` (`tenant_id`,`status`,`next_reconcile_at`)
...
CREATE TABLE IF NOT EXISTS `zsjos_payment_transaction` (
  ...
  `source` varchar(16) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'notify/query',
  `currency` varchar(16) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'CNY' COMMENT '币种',
  `payment_method` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '渠道支付方式',
  `paid_at` datetime NOT NULL COMMENT '渠道支付成功时间',
  `external_channel` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '外部支付渠道',
  `external_transaction_no` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '外部渠道流水号',
  `trx_id` varchar(128) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '通联交易号',
  `channel_transaction_no` varchar(128) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '通联渠道流水号',
  `payer_reference` varchar(256) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '实际付款人引用，不作为业务归属',
  `callback_event_id` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '支付回调事件编号',
...
CREATE TABLE IF NOT EXISTS `zsjos_person` (
  ...
  `person_no` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Person 业务编号',
  `name` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '姓名',
  `mobile` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '手机号（脱敏展示）',
  `wechat_id` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '微信号（脱敏展示）',
  `identity_status` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '身份状态，协议值待确认',
...
CREATE TABLE IF NOT EXISTS `zsjos_person_contact_claim` (
  ...
  `reservation_key` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '事务预占键',
  `creator` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT '',
  `create_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `updater` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT '',
  `update_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
...
CREATE TABLE IF NOT EXISTS `zsjos_person_merge_event` (
  ...
  `event_type` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '合并/拆分事件类型',
  `reason` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '原因',
  `operator_user_id` bigint DEFAULT NULL COMMENT '操作人用户编号',
...
CREATE TABLE IF NOT EXISTS `zsjos_personnel_state` (
  ...
  `business_state` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'enabled/disabled/departed',
...
CREATE TABLE IF NOT EXISTS `zsjos_positioning_card` (
  ...
  `fields_snapshot_json` json DEFAULT NULL,
  `values_snapshot_json` json DEFAULT NULL,
  `dict_snapshot_json` json DEFAULT NULL,
  `trial_end_date` date DEFAULT NULL,
  `version_no` int NOT NULL,
  `layer1_json` json NOT NULL,
  `layer2_json` json NOT NULL,
  `formula_json` json NOT NULL,
  `feasibility_json` json NOT NULL,
  `content_form_json` json NOT NULL,
  `compliance_json` json NOT NULL,
  `professional_risk` bit(1) NOT NULL DEFAULT b'0',
  `status` varchar(32) COLLATE utf8mb4_unicode_ci NOT NULL,
  `ip_process_instance_id` varchar(64) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `ip_reviewer_user_id` bigint DEFAULT NULL,
  `ip_reviewed_at` datetime DEFAULT NULL,
  `operator_reviewed_by_user_id` bigint DEFAULT NULL,
  `operator_reviewed_at` datetime DEFAULT NULL,
  `operator_review_comment` varchar(2000) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `version` int NOT NULL DEFAULT '0',
  `creator` varchar(64) COLLATE utf8mb4_unicode_ci DEFAULT '',
  `create_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `updater` varchar(64) COLLATE utf8mb4_unicode_ci DEFAULT '',
...
-- zsjos_positioning_card_submission
CREATE TABLE IF NOT EXISTS `zsjos_positioning_card_submission` (
  ...
  `template_id` bigint DEFAULT NULL,
  `template_version_id` bigint DEFAULT NULL,
  `fields_snapshot_json` longtext COLLATE utf8mb4_unicode_ci,
  `values_snapshot_json` longtext COLLATE utf8mb4_unicode_ci,
  `dict_snapshot_json` longtext COLLATE utf8mb4_unicode_ci,
  `layer1_json` longtext COLLATE utf8mb4_unicode_ci,
  `layer2_json` longtext COLLATE utf8mb4_unicode_ci,
  `formula_json` longtext COLLATE utf8mb4_unicode_ci,
  `feasibility_json` longtext COLLATE utf8mb4_unicode_ci,
  `content_form_json` longtext COLLATE utf8mb4_unicode_ci,
  `compliance_json` longtext COLLATE utf8mb4_unicode_ci,
  `trial_end_date` date DEFAULT NULL,
  `professional_risk` bit(1) NOT NULL DEFAULT b'0',
  `status` varchar(32) COLLATE utf8mb4_unicode_ci NOT NULL,
  `submitted_at` datetime DEFAULT NULL,
  `operator_reviewed_by_user_id` bigint DEFAULT NULL,
  `operator_reviewed_at` datetime DEFAULT NULL,
  `operator_review_comment` varchar(500) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `student_decision` varchar(32) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `student_decision_comment` varchar(2000) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
-- zsjos_positioning_card_version
CREATE TABLE IF NOT EXISTS `zsjos_positioning_card_version` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `positioning_card_id` bigint NOT NULL,
  `version_no` int NOT NULL,
  `before_json` json DEFAULT NULL,
  `after_json` json NOT NULL,
  `change_reason` varchar(2000) COLLATE utf8mb4_unicode_ci NOT NULL,
  ...
  `tenant_id` bigint NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `uk_tenant_card_version` (`tenant_id`,`positioning_card_id`,`version_no`,`deleted`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='定位卡追加版本';

-- zsjos_positioning_confirmation_link
CREATE TABLE IF NOT EXISTS `zsjos_positioning_confirmation_link` (
  ...
  KEY `idx_token_status_expires` (`token_hash`,`status`,`expires_at`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='定位卡学员确认链接';

-- zsjos_positioning_exec_card
CREATE TABLE IF NOT EXISTS `zsjos_positioning_exec_card` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `exec_card_no` varchar(64) COLLATE utf8mb4_unicode_ci NOT NULL,
  `account_id` bigint NOT NULL,
  `positioning_card_id` bigint NOT NULL,
  `execution_json` json NOT NULL,
  `review_due_at` datetime NOT NULL,
  `allowed_reposition_count` int DEFAULT NULL,
  `student_confirmed_at` datetime DEFAULT NULL,
  `director_confirmed_at` datetime DEFAULT NULL,
  `operator_confirmed_at` datetime DEFAULT NULL,
  `signature_snapshot_json` json DEFAULT NULL,
  ...
  `tenant_id` bigint NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `uk_tenant_exec_card_no` (`tenant_id`,`exec_card_no`,`deleted`),
  KEY `idx_tenant_account_status` (`tenant_id`,`account_id`,`status`)
...
CREATE TABLE IF NOT EXISTS `zsjos_product` (
  `id` bigint NOT NULL AUTO_INCREMENT COMMENT '产品编号',
  `product_ref` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '稳定产品引用，创建后不可修改',
  `name` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '产品/课程名称',
  `status` tinyint NOT NULL DEFAULT '0' COMMENT '状态（0启用 1停用）',
  ...
  `subtitle` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '课程副标题',
  `description` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci COMMENT '课程详情',
  `target_audience` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '适用人群',
  `study_duration` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '学习时长',
  `study_mode` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '学习方式',
  `cover_image` varchar(1024) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '课程封面',
...
CREATE TABLE IF NOT EXISTS `zsjos_product_attr` (
  ...
  `attr_key` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '稳定属性键',
  `attr_name` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '属性名称',
...
CREATE TABLE IF NOT EXISTS `zsjos_product_sku` (
  ...
  `sku_ref` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `sku_name` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `attr_values_json` json NOT NULL,
  `attr_values_hash` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE IF NOT EXISTS `zsjos_production_ticket` (
  ...
  `positioning_submission_id` bigint DEFAULT NULL COMMENT '发起时已确认定位提交ID',
  ...
  `expected_delivered_at` datetime DEFAULT NULL,
  `deadline_at` datetime DEFAULT NULL,
  `entitlement_quota` int NOT NULL DEFAULT '0',
  `remaining_count` int NOT NULL DEFAULT '0',
  `max_revision_count` int DEFAULT NULL,
  `revision_count` int NOT NULL DEFAULT '0',
  `rework_reason_type` varchar(24) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `over_entitlement` bit(1) NOT NULL DEFAULT b'0',
  `over_entitlement_handling` varchar(24) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `over_entitlement_process_instance_id` varchar(64) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `status` varchar(24) COLLATE utf8mb4_unicode_ci NOT NULL,
  `version` int NOT NULL DEFAULT '0',
  `creator` varchar(64) COLLATE utf8mb4_unicode_ci DEFAULT '',
  `create_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  ...
  `tenant_id` bigint NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `uk_tenant_ticket_no` (`tenant_id`,`ticket_no`,`deleted`),
  UNIQUE KEY `uk_tenant_create_idempotency` (`tenant_id`,`idempotency_key`),
...
-- zsjos_production_ticket_command
...
-- zsjos_production_ticket_item
CREATE TABLE IF NOT EXISTS `zsjos_production_ticket_item` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `ticket_id` bigint NOT NULL,
  `content_id` bigint NOT NULL,
  `delivered_at` datetime DEFAULT NULL,
  `item_status` varchar(24) COLLATE utf8mb4_unicode_ci NOT NULL,
  `creator` varchar(64) COLLATE utf8mb4_unicode_ci DEFAULT '',
  `create_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `updater` varchar(64) COLLATE utf8mb4_unicode_ci DEFAULT '',
  `update_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  ...
  `tenant_id` bigint NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `uk_tenant_ticket_content` (`tenant_id`,`ticket_id`,`content_id`,`deleted`),
...
CREATE TABLE IF NOT EXISTS `zsjos_purchase_intent` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `purchase_intent_no` varchar(64) COLLATE utf8mb4_unicode_ci NOT NULL,
  `collection_mode` varchar(32) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'online_link/offline_paid',
  `purchase_type` varchar(32) COLLATE utf8mb4_unicode_ci NOT NULL,
  ...
  `last_idempotency_key` varchar(128) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `version` int NOT NULL DEFAULT '0',
  `creator` varchar(64) COLLATE utf8mb4_unicode_ci DEFAULT '',
  `create_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `updater` varchar(64) COLLATE utf8mb4_unicode_ci DEFAULT '',
  ...
  `tenant_id` bigint NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
  UNIQUE KEY `uk_tenant_purchase_intent_no` (`tenant_id`,`purchase_intent_no`),
...
CREATE TABLE IF NOT EXISTS `zsjos_refund_case` (
  ...
  `order_id` bigint NOT NULL COMMENT '订单编号',
  `status` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '退款申请状态',
  ...
  `currency` varchar(16) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'CNY' COMMENT '币种',
  `reason` varchar(1000) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '退款原因',
  `evidence_refs` json DEFAULT NULL COMMENT '证据引用',
  `requested_by_user_id` bigint NOT NULL COMMENT '申请人用户编号',
  `approved_by_user_id` bigint DEFAULT NULL COMMENT '批准人用户编号',
  `process_instance_id` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '独立退款 BPM 流程实例编号',
  `external_refund_no` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '外部退款流水号',
  `completed_at` datetime DEFAULT NULL COMMENT '完成时间',
  `version` int NOT NULL DEFAULT '0' COMMENT '乐观锁版本',
  `creator` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT '' COMMENT '创建者',
  `create_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
...
CREATE TABLE IF NOT EXISTS `zsjos_registration_case` (
  ...
  `status` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '报名服务状态',
...
-- zsjos_registration_case_checklist_item
CREATE TABLE IF NOT EXISTS `zsjos_registration_case_checklist_item` (
  ...
  `attachment_required` bit(1) NOT NULL DEFAULT b'0',
  `checked_by_user_id` bigint DEFAULT NULL,
  ...
  `tenant_id` bigint NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `uk_registration_case_item` (`tenant_id`,`registration_case_id`,`template_item_id`,`deleted`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;

-- zsjos_registration_case_route
CREATE TABLE IF NOT EXISTS `zsjos_registration_case_route` (
  ...
  `assignee_user_id` bigint DEFAULT NULL,
  `assignee_name_snapshot` varchar(100) DEFAULT NULL,
  `sort` int NOT NULL,
  `version` int NOT NULL DEFAULT '0',
  `creator` varchar(64) DEFAULT '',
  `create_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  ...
  `tenant_id` bigint NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `uk_registration_case_route` (`tenant_id`,`registration_case_id`,`route_option_id`,`deleted`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;

-- zsjos_registration_checklist_template
CREATE TABLE IF NOT EXISTS `zsjos_registration_checklist_template` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `name` varchar(100) NOT NULL,
  `published_version_id` bigint DEFAULT NULL,
  `draft_version_id` bigint DEFAULT NULL,
  `version` int NOT NULL DEFAULT '0',
  `creator` varchar(64) DEFAULT '',
  `create_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `updater` varchar(64) DEFAULT '',
  ...
  `tenant_id` bigint NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `uk_registration_template_tenant` (`tenant_id`,`deleted`)
...
CREATE TABLE IF NOT EXISTS `zsjos_registration_checklist_template_item` (
  ...
  `system_required` bit(1) NOT NULL DEFAULT b'0',
  `attachment_required` bit(1) NOT NULL DEFAULT b'0',
  `creator` varchar(64) DEFAULT '',
  `create_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `updater` varchar(64) DEFAULT '',
  ...
  `tenant_id` bigint NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `uk_registration_version_item` (`tenant_id`,`version_id`,`item_key`,`deleted`)
...
CREATE TABLE IF NOT EXISTS `zsjos_registration_checklist_version` (
  ...
  `tenant_id` bigint NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `uk_registration_template_version` (`tenant_id`,`template_id`,`version_no`,`deleted`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;

-- zsjos_registration_command
CREATE TABLE IF NOT EXISTS `zsjos_registration_command` (
  ...
  `operator_user_id` bigint NOT NULL,
  `result_attachment_id` bigint DEFAULT NULL COMMENT '上传附件命令的精确结果附件编号',
  `creator` varchar(64) DEFAULT '',
  `create_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `updater` varchar(64) DEFAULT '',
  `update_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  ...
  `tenant_id` bigint NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `uk_registration_command_key` (`tenant_id`,`idempotency_key`,`deleted`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
CREATE TABLE IF NOT EXISTS `zsjos_registration_item` (
  ...
  `item_type` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '报名记录类型',
  `item_label_snapshot` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '清单标题快照',
  `occurred_at` datetime NOT NULL COMMENT '实际发生时间',
  ...
  `remark` varchar(1000) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '说明',
  `creator` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT '' COMMENT '创建者',
  `create_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `updater` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT '' COMMENT '更新者',
  `update_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
...
-- zsjos_registration_item_attachment
CREATE TABLE IF NOT EXISTS `zsjos_registration_item_attachment` (
  ...
  `tenant_id` bigint NOT NULL,
  PRIMARY KEY (`id`),
  KEY `idx_registration_attachment_item` (`tenant_id`,`checklist_item_id`,`uploaded_at`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
CREATE TABLE IF NOT EXISTS `zsjos_registration_route_option` (
  ...
  `tenant_id` bigint NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `uk_registration_version_route` (`tenant_id`,`version_id`,`option_key`,`deleted`)
...
CREATE TABLE IF NOT EXISTS `zsjos_schema_version` (
  ...
  PRIMARY KEY (`version`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='ZSJOS database schema versions';
...
CREATE TABLE IF NOT EXISTS `zsjos_service_record` (
  ...
  `record_type` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '服务记录类型',
  `occurred_at` datetime NOT NULL COMMENT '实际发生时间',
  `recorded_by_user_id` bigint NOT NULL COMMENT '记录人用户编号',
  `content` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci COMMENT '服务内容',
  `evidence_refs` json DEFAULT NULL COMMENT '凭证引用',
  `creator` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT '' COMMENT '创建者',
  `create_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `updater` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT '' COMMENT '更新者',
...
CREATE TABLE IF NOT EXISTS `zsjos_service_relation` (
  ...
  `status` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '服务关系状态',
  `owner_user_id` bigint DEFAULT NULL COMMENT '学生服务负责人用户编号',
  `acceptance_status` varchar(24) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'pending' COMMENT '接收状态',
  `accepted_by_user_id` bigint DEFAULT NULL COMMENT '确认接收人用户编号',
  `accepted_at` datetime DEFAULT NULL COMMENT '确认接收时间',
  `content_director_user_id` bigint DEFAULT NULL COMMENT '编导用户编号',
  `career_planner_user_id` bigint DEFAULT NULL COMMENT '职业规划师用户编号',
  `operator_user_id` bigint DEFAULT NULL,
  `director_stage` varchar(32) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'precheck',
  `director_interview_at` datetime DEFAULT NULL,
  `service_snapshot` json DEFAULT NULL COMMENT '服务权益及产品规则快照',
  `delivery_stage` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '学习交付阶段',
  `delivery_data_json` json DEFAULT NULL COMMENT '交付阶段事实快照',
  `exam_date` date DEFAULT NULL COMMENT '学员考试日期',
  `exam_date_version` int NOT NULL DEFAULT '0' COMMENT '考试日期版本',
  `last_notified_exam_date` date DEFAULT NULL COMMENT '最近已通知考试日期',
  `exam_notice_sent_at` datetime DEFAULT NULL COMMENT '考前通知发送时间',
  `activated_at` datetime NOT NULL COMMENT '激活时间',
  ...
  `termination_reason` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '终止原因',
  `version` int NOT NULL DEFAULT '0' COMMENT '乐观锁版本',
  `creator` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT '' COMMENT '创建者',
  `create_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `updater` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT '' COMMENT '更新者',
  ...
  `deleted` bit(1) NOT NULL DEFAULT b'0' COMMENT '是否删除',
  `tenant_id` bigint NOT NULL DEFAULT '0' COMMENT '租户编号',
  `director_form_config_id` bigint DEFAULT NULL,
  `director_form_config_version` int DEFAULT NULL,
  `director_precheck_draft_json` json DEFAULT NULL,
  `director_precheck_snapshot_json` json DEFAULT NULL,
  `director_interview_draft_json` json DEFAULT NULL,
  `director_interview_snapshot_json` json DEFAULT NULL,
  `director_precheck_draft_version` int NOT NULL DEFAULT '0' COMMENT '编导资料预审草稿版本',
  `director_interview_draft_version` int NOT NULL DEFAULT '0' COMMENT '编导学员采访草稿版本',
  PRIMARY KEY (`id`),
...
CREATE TABLE IF NOT EXISTS `zsjos_standard_form` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `form_type_value` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL,
  `form_type_label_snapshot` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL,
  `biz_type` varchar(32) COLLATE utf8mb4_unicode_ci NOT NULL,
  `biz_id` bigint NOT NULL,
  `form_data_json` json NOT NULL,
  `filled_by_user_id` bigint NOT NULL,
  `status` varchar(24) COLLATE utf8mb4_unicode_ci NOT NULL,
  `version` int NOT NULL DEFAULT '0',
  `creator` varchar(64) COLLATE utf8mb4_unicode_ci DEFAULT '',
  `create_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  ...
  `tenant_id` bigint NOT NULL,
  PRIMARY KEY (`id`),
  KEY `idx_tenant_biz_form` (`tenant_id`,`biz_type`,`biz_id`,`form_type_value`)
...
CREATE TABLE IF NOT EXISTS `zsjos_student_collaborator_assignment_log` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `service_relation_id` bigint NOT NULL,
  `collaborator_type` varchar(32) COLLATE utf8mb4_unicode_ci NOT NULL,
  `previous_user_id` bigint DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `zsjos_student_contact_config_command` (
  ...
  `request_fingerprint` varchar(64) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `result_config_id` bigint NOT NULL,
  `creator` varchar(64) COLLATE utf8mb4_unicode_ci DEFAULT '',
  `create_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `updater` varchar(64) COLLATE utf8mb4_unicode_ci DEFAULT '',
  `update_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
...
CREATE TABLE IF NOT EXISTS `zsjos_student_contact_config_version` (
  ...
  `version_no` int NOT NULL,
  `status` varchar(24) COLLATE utf8mb4_unicode_ci NOT NULL,
  `first_contact_timeout_minutes` int NOT NULL,
  `study_plan_timeout_minutes` int NOT NULL,
  `checklist_json` json NOT NULL,
  `quick_notes_json` json NOT NULL,
  `collaborator_tabs_json` json NOT NULL,
  `forms_json` json DEFAULT NULL COMMENT '发布业务表单字段定义',
  `version` int NOT NULL DEFAULT '0',
  `creator` varchar(64) COLLATE utf8mb4_unicode_ci DEFAULT '',
  `create_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `updater` varchar(64) COLLATE utf8mb4_unicode_ci DEFAULT '',
  ...
  UNIQUE KEY `uk_tenant_version_no` (`tenant_id`,`version_no`,`deleted`),
  KEY `idx_tenant_status` (`tenant_id`,`status`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='学员联系配置版本';
...
CREATE TABLE IF NOT EXISTS `zsjos_student_contact_extension` (
  ...
  `reason_value` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL,
  `reason_label_snapshot` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL,
  `description` varchar(1000) COLLATE utf8mb4_unicode_ci NOT NULL,
  `attachment_file_ids_json` json NOT NULL,
  ...
  `resolved_at` datetime DEFAULT NULL,
  `idempotency_key` varchar(128) COLLATE utf8mb4_unicode_ci NOT NULL,
  `withdrawal_idempotency_key` varchar(64) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `version` int NOT NULL DEFAULT '0',
  `creator` varchar(64) COLLATE utf8mb4_unicode_ci DEFAULT '',
  `create_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `updater` varchar(64) COLLATE utf8mb4_unicode_ci DEFAULT '',
...
CREATE TABLE IF NOT EXISTS `zsjos_student_contact_record` (
  ...
  `contact_type` varchar(64) COLLATE utf8mb4_unicode_ci NOT NULL,
  `successful` bit(1) NOT NULL,
  `unsuccessful_reason_value` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `unsuccessful_reason_label_snapshot` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `remark` varchar(2000) COLLATE utf8mb4_unicode_ci NOT NULL,
  `attachment_file_ids_json` json NOT NULL,
  `checklist_result_json` json NOT NULL,
  `delivery_stage` varchar(64) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `delivery_data_json` json DEFAULT NULL,
  `next_contact_at` datetime NOT NULL,
  `operator_user_id` bigint NOT NULL,
  `submitted_at` datetime NOT NULL,
  `idempotency_key` varchar(128) COLLATE utf8mb4_unicode_ci NOT NULL,
  `request_fingerprint` varchar(64) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
...
-- zsjos_student_exam_notice_rule
...
CREATE TABLE IF NOT EXISTS `zsjos_subordinate_sales_audit_log` (
  ...
  `lead_id` bigint DEFAULT NULL,
  `before_value` varchar(1000) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `after_value` varchar(1000) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `reason` varchar(500) COLLATE utf8mb4_unicode_ci NOT NULL,
  `occurred_at` datetime NOT NULL,
  `creator` varchar(64) COLLATE utf8mb4_unicode_ci DEFAULT '',
  `create_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  ...
  `tenant_id` bigint NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
  KEY `idx_tenant_operator_time` (`tenant_id`,`operator_user_id`,`occurred_at`),
...
-- zsjos_subordinate_sales_command
CREATE TABLE IF NOT EXISTS `zsjos_subordinate_sales_command` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `operator_user_id` bigint NOT NULL,
  `idempotency_key` varchar(40) COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE IF NOT EXISTS `zsjos_user_relation` (
  ...
  `scene` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '业务场景',
...
CREATE TABLE IF NOT EXISTS `zsjos_user_relation_log` (
  `id` bigint NOT NULL AUTO_INCREMENT COMMENT '日志编号',
  `scene` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '业务场景',
  `source_user_ids` varchar(2000) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '来源用户编号集合',
  `target_user_ids` varchar(2000) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '目标用户编号集合',
  `action_type` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '操作类型',
  `operator_user_id` bigint NOT NULL COMMENT '操作人用户编号',
  `creator` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT '' COMMENT '创建者',
  `create_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `updater` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT '' COMMENT '更新者',
...
CREATE TABLE IF NOT EXISTS `zsjos_user_relation_scene` (
  ...
  `source_label` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '来源用户称谓',
  `target_label` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '目标用户称谓',
  `source_post_code` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '来源岗位编码',
  `target_post_code` varchar(64) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '目标岗位编码',
  `target_eligibility_type` varchar(16) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'post' COMMENT '目标资格：post/permission',
  `target_permission_code` varchar(128) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '目标功能权限码',
  `status` tinyint NOT NULL DEFAULT '0' COMMENT '状态（0启用 1停用）',
  `remark` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '备注',
  `creator` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT '' COMMENT '创建者',
  `create_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  ...
  UNIQUE KEY `uk_tenant_code` (`tenant_id`,`code`),
  KEY `idx_tenant_status` (`tenant_id`,`status`)
) ENGINE=InnoDB AUTO_INCREMENT=10 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='ZSJOS 用户关系场景表';

-- zsjos_withdrawal
CREATE TABLE IF NOT EXISTS `zsjos_withdrawal` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `withdrawal_no` varchar(32) COLLATE utf8mb4_unicode_ci NOT NULL,
  `partner_id` bigint NOT NULL,
  ...
  `available_balance_snapshot` decimal(12,2) NOT NULL,
  `account_name_snapshot` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL,
  `card_number_snapshot` varchar(32) COLLATE utf8mb4_unicode_ci NOT NULL,
  `bank_name_snapshot` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL,
  `branch_name_snapshot` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `process_instance_id` varchar(64) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `submitted_at` datetime NOT NULL,
  ...
  `cancelled_at` datetime DEFAULT NULL,
  `bank_transaction_no` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `proof_file_id` bigint DEFAULT NULL,
  `proof_file_name_snapshot` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `proof_file_type_snapshot` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `payout_remark` varchar(500) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `tenant_id` bigint NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
  UNIQUE KEY `uk_tenant_withdrawal_no` (`tenant_id`,`withdrawal_no`),
  UNIQUE KEY `uk_tenant_process_instance` (`tenant_id`,`process_instance_id`),
  UNIQUE KEY `uk_tenant_bank_transaction` (`tenant_id`,`bank_transaction_no`),
  KEY `idx_applicant_status` (`tenant_id`,`applicant_user_id`,`status`,`submitted_at`),
  KEY `idx_finance_status` (`tenant_id`,`status`,`submitted_at`)
...
CREATE TABLE IF NOT EXISTS `zsjos_withdrawal_item` (
  ...
  `active_cashback_id` bigint GENERATED ALWAYS AS (if((`active_flag` = 0x01),`cashback_id`,NULL)) STORED,
  `creator` varchar(64) COLLATE utf8mb4_unicode_ci DEFAULT '',
  `create_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `updater` varchar(64) COLLATE utf8mb4_unicode_ci DEFAULT '',
  `update_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  ...
  `tenant_id` bigint NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
  UNIQUE KEY `uk_withdrawal_cashback` (`tenant_id`,`withdrawal_id`,`cashback_id`),
  UNIQUE KEY `uk_active_cashback` (`tenant_id`,`active_cashback_id`),
  KEY `idx_withdrawal` (`tenant_id`,`withdrawal_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='ZSJOS 提现返现关联';

-- zsjos_work_attachment
CREATE TABLE IF NOT EXISTS `zsjos_work_attachment` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `subject_type` varchar(32) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'report/summary',
  ...
  `tenant_id` bigint NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
  UNIQUE KEY `uk_tenant_subject_file` (`tenant_id`,`subject_type`,`subject_id`,`infra_file_id`),
...
CREATE TABLE IF NOT EXISTS `zsjos_work_change` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `subject_type` varchar(32) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'plan/task',
  `subject_id` bigint NOT NULL,
  ...
  `tenant_id` bigint NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
  KEY `idx_tenant_subject_changed` (`tenant_id`,`subject_type`,`subject_id`,`changed_at`,`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='ZSJOS 工作计划与任务变更历史';

-- zsjos_work_field_value
CREATE TABLE IF NOT EXISTS `zsjos_work_field_value` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `field_definition_id` bigint NOT NULL,
  `subject_type` varchar(32) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'plan/task/report/summary',
  `subject_id` bigint NOT NULL,
  `value_text` varchar(4000) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `zsjos_work_order` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `tenant_id` bigint NOT NULL DEFAULT '0',
  `business_type` varchar(32) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'GENERIC',
  `business_id` bigint DEFAULT NULL,
  `order_no` varchar(64) COLLATE utf8mb4_unicode_ci NOT NULL,
  `scene_code` varchar(64) COLLATE utf8mb4_unicode_ci NOT NULL,
  `scene_name_snapshot` varchar(128) COLLATE utf8mb4_unicode_ci NOT NULL,
  `assignment_mode` varchar(32) COLLATE utf8mb4_unicode_ci NOT NULL,
  `scene_version_id` bigint DEFAULT NULL,
  `processor_type` varchar(32) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'GENERIC',
  `target_dept_id` bigint DEFAULT NULL,
  `rejection_strategy_snapshot` varchar(32) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `candidate_qualification_mode` varchar(32) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `candidate_role_scopes_json` json DEFAULT NULL,
  `candidate_dept_scopes_json` json DEFAULT NULL,
  `source_subject_type` varchar(32) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'ADMIN' COMMENT '发起主体类型',
  `source_user_id` bigint NOT NULL,
  `target_user_id` bigint DEFAULT NULL,
  `source_name_snapshot` varchar(128) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `target_name_snapshot` varchar(128) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `status` varchar(40) COLLATE utf8mb4_unicode_ci NOT NULL,
  `field_snapshot_json` json NOT NULL,
  `value_json` json NOT NULL,
  `attachment_ids_json` json NOT NULL,
  `remark` varchar(2000) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `current_round` int NOT NULL DEFAULT '1',
  `completion_remark` varchar(4000) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `completion_attachment_ids_json` json DEFAULT NULL,
  `idempotency_key` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL,
  `command_subject_type` varchar(32) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'ADMIN' COMMENT '命令主体类型',
  `command_user_id` bigint NOT NULL,
  `request_fingerprint` varchar(64) COLLATE utf8mb4_unicode_ci NOT NULL,
  `return_reason` varchar(1000) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  UNIQUE KEY `uk_tenant_order_no` (`tenant_id`,`order_no`),
  UNIQUE KEY `uk_tenant_idempotency` (`tenant_id`,`idempotency_key`),
  UNIQUE KEY `uk_tenant_business` (`tenant_id`,`business_type`,`business_id`),
  KEY `idx_pool` (`tenant_id`,`scene_code`,`status`,`create_time`),
  KEY `idx_source_user` (`tenant_id`,`source_user_id`,`status`,`create_time`),
  KEY `idx_target_user` (`tenant_id`,`target_user_id`,`status`,`create_time`),
  KEY `idx_tenant_business_type` (`tenant_id`,`business_type`,`create_time`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='ZSJOS 通用工单';

-- zsjos_work_order_attachment
CREATE TABLE IF NOT EXISTS `zsjos_work_order_attachment` (
  ...
  `file_name_snapshot` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `mime_type_snapshot` varchar(128) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `file_size_snapshot` bigint DEFAULT NULL,
  `sort` int NOT NULL DEFAULT '0',
  `creator` varchar(64) COLLATE utf8mb4_unicode_ci DEFAULT '',
  `create_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `updater` varchar(64) COLLATE utf8mb4_unicode_ci DEFAULT '',
...
CREATE TABLE IF NOT EXISTS `zsjos_work_order_history` (
  ...
  `operator_subject_type` varchar(32) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'ADMIN' COMMENT '操作主体类型',
  `operator_user_id` bigint NOT NULL,
  ...
  `result_remark` varchar(4000) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `attachment_ids_json` json DEFAULT NULL,
  `creator` varchar(64) COLLATE utf8mb4_unicode_ci DEFAULT '',
  `create_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `updater` varchar(64) COLLATE utf8mb4_unicode_ci DEFAULT '',
  ...
  `deleted_time` datetime DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `uk_order_key` (`tenant_id`,`work_order_id`,`idempotency_key`),
  KEY `idx_order_time` (`tenant_id`,`work_order_id`,`operated_at`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='ZSJOS 工单状态历史';

-- zsjos_work_order_number_counter
CREATE TABLE IF NOT EXISTS `zsjos_work_order_number_counter` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `tenant_id` bigint NOT NULL DEFAULT '0',
  `number_prefix` varchar(12) COLLATE utf8mb4_unicode_ci NOT NULL,
  `reset_key` varchar(16) COLLATE utf8mb4_unicode_ci NOT NULL,
  `current_value` bigint NOT NULL DEFAULT '0',
  `creator` varchar(64) COLLATE utf8mb4_unicode_ci DEFAULT '',
  `create_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `updater` varchar(64) COLLATE utf8mb4_unicode_ci DEFAULT '',
  ...
  `deleted_time` datetime DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `uk_tenant_prefix_period` (`tenant_id`,`number_prefix`,`reset_key`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='ZSJOS 工单编号计数器';

-- zsjos_work_order_scene
CREATE TABLE IF NOT EXISTS `zsjos_work_order_scene` (
  ...
  `source_post_code` varchar(64) COLLATE utf8mb4_unicode_ci NOT NULL,
  `target_post_code` varchar(64) COLLATE utf8mb4_unicode_ci NOT NULL,
  `assignment_mode` varchar(32) COLLATE utf8mb4_unicode_ci NOT NULL,
  `fields_json` json NOT NULL,
  `status` tinyint NOT NULL DEFAULT '1',
  `category_value` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `category_label_snapshot` varchar(128) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `icon` varchar(64) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `sort` int NOT NULL DEFAULT '0',
  `processor_type` varchar(32) COLLATE utf8mb4_unicode_ci DEFAULT 'GENERIC',
  `allowed_assignment_types_json` json DEFAULT NULL,
  `source_qualification_mode` varchar(32) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `source_role_scopes_json` json DEFAULT NULL,
  `source_dept_scopes_json` json DEFAULT NULL,
  `target_qualification_mode` varchar(32) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `target_role_scopes_json` json DEFAULT NULL,
  `target_dept_scopes_json` json DEFAULT NULL,
  `rejection_strategy` varchar(32) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `number_prefix` varchar(12) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `number_reset_period` varchar(16) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `number_sequence_width` int DEFAULT NULL,
  `lifecycle_status` varchar(16) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'DRAFT',
  `published_version_id` bigint DEFAULT NULL,
...
-- zsjos_work_order_scene_version
CREATE TABLE IF NOT EXISTS `zsjos_work_order_scene_version` (
  ...
  `name` varchar(128) COLLATE utf8mb4_unicode_ci NOT NULL,
  `remark` varchar(500) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `category_value` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL,
  `category_label_snapshot` varchar(128) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `icon` varchar(64) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `sort` int NOT NULL DEFAULT '0',
  `processor_type` varchar(32) COLLATE utf8mb4_unicode_ci NOT NULL,
  `allowed_assignment_types_json` json NOT NULL,
  `source_qualification_mode` varchar(32) COLLATE utf8mb4_unicode_ci NOT NULL,
  `source_role_scopes_json` json DEFAULT NULL,
  `source_dept_scopes_json` json DEFAULT NULL,
  `target_qualification_mode` varchar(32) COLLATE utf8mb4_unicode_ci NOT NULL,
  `target_role_scopes_json` json DEFAULT NULL,
  `target_dept_scopes_json` json DEFAULT NULL,
  `rejection_strategy` varchar(32) COLLATE utf8mb4_unicode_ci NOT NULL,
  `number_prefix` varchar(12) COLLATE utf8mb4_unicode_ci NOT NULL,
  `number_reset_period` varchar(16) COLLATE utf8mb4_unicode_ci NOT NULL,
  `number_sequence_width` int NOT NULL,
  `fields_json` json NOT NULL,
  ...
  `deleted_time` datetime DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `uk_scene_version` (`tenant_id`,`scene_id`,`version_no`),
  KEY `idx_scene_code` (`tenant_id`,`code`)
...
CREATE TABLE IF NOT EXISTS `zsjos_work_plan` (
  ...
  `title` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '计划名称',
  `period_type` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '周期类型',
  `start_date` date NOT NULL,
  `end_date` date NOT NULL,
  `status` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'draft/active/completed/cancelled',
  `creator_user_id` bigint NOT NULL,
  `owner_user_id` bigint NOT NULL,
  ...
  `objective` varchar(4000) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '计划目标说明',
  `key_requirements` varchar(4000) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '重点要求',
  `published_at` datetime DEFAULT NULL,
  `completed_at` datetime DEFAULT NULL,
  `cancelled_at` datetime DEFAULT NULL,
...
-- zsjos_work_plan_field_definition
CREATE TABLE IF NOT EXISTS `zsjos_work_plan_field_definition` (
  ...
  `section` varchar(32) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'plan/task/report/summary',
  ...
  `origin` varchar(32) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'template/supplemental',
  `sort` int NOT NULL DEFAULT '0',
  `creator` varchar(64) COLLATE utf8mb4_unicode_ci DEFAULT '',
  `create_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `updater` varchar(64) COLLATE utf8mb4_unicode_ci DEFAULT '',
  ...
  `tenant_id` bigint NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
  UNIQUE KEY `uk_tenant_plan_field` (`tenant_id`,`plan_id`,`field_key`),
...
-- zsjos_work_plan_summary
CREATE TABLE IF NOT EXISTS `zsjos_work_plan_summary` (
  `id` bigint NOT NULL AUTO_INCREMENT COMMENT '计划总结编号',
  `plan_id` bigint NOT NULL,
  `summary` varchar(4000) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `submitter_user_id` bigint NOT NULL,
  `submitted_at` datetime NOT NULL,
  `creator` varchar(64) COLLATE utf8mb4_unicode_ci DEFAULT '',
  `create_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE IF NOT EXISTS `zsjos_work_plan_template` (
  ...
  `code` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '系统生成编码',
  `name` varchar(150) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '模板名称',
  `description` varchar(1000) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '模板说明',
  `status` varchar(32) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'draft' COMMENT 'draft/published/disabled',
  ...
  `tenant_id` bigint NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
  UNIQUE KEY `uk_tenant_type_code` (`tenant_id`,`type_id`,`code`),
...
-- zsjos_work_plan_template_field
CREATE TABLE IF NOT EXISTS `zsjos_work_plan_template_field` (
  ...
  `field_key` varchar(64) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '系统生成稳定字段编码',
  `label` varchar(150) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '字段名称',
  `section` varchar(32) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'plan/task/report/summary',
  `field_type` varchar(32) COLLATE utf8mb4_unicode_ci NOT NULL,
  `required` bit(1) NOT NULL DEFAULT b'0',
  `unit` varchar(32) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `tenant_id` bigint NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
  UNIQUE KEY `uk_tenant_version_field` (`tenant_id`,`template_version_id`,`field_key`),
...
-- zsjos_work_plan_template_scope
...
CREATE TABLE IF NOT EXISTS `zsjos_work_plan_template_task` (
  ...
  `due_offset_basis` varchar(16) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `tenant_id` bigint NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
  KEY `idx_tenant_version_sort` (`tenant_id`,`template_version_id`,`sort`,`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='ZSJOS 工作计划模板默认任务';

-- zsjos_work_plan_template_version
CREATE TABLE IF NOT EXISTS `zsjos_work_plan_template_version` (
  `id` bigint NOT NULL AUTO_INCREMENT COMMENT '模板版本编号',
  `template_id` bigint NOT NULL COMMENT '模板编号',
  `version_no` int NOT NULL COMMENT '版本号',
  `status` varchar(32) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'draft' COMMENT 'draft/published',
  `period_mode` varchar(32) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'custom' COMMENT 'day/week/month/quarter/year/custom',
  `published_at` datetime DEFAULT NULL,
  `creator` varchar(64) COLLATE utf8mb4_unicode_ci DEFAULT '',
  `create_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `updater` varchar(64) COLLATE utf8mb4_unicode_ci DEFAULT '',
  ...
  `tenant_id` bigint NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
  UNIQUE KEY `uk_tenant_template_version` (`tenant_id`,`template_id`,`version_no`),
  KEY `idx_tenant_status` (`tenant_id`,`status`,`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='ZSJOS 工作计划模板版本';

-- zsjos_work_plan_type
CREATE TABLE IF NOT EXISTS `zsjos_work_plan_type` (
  ...
  `description` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '类型说明',
...
CREATE TABLE IF NOT EXISTS `zsjos_work_report` (
  ...
  `task_id` bigint NOT NULL,
  `revision_no` int NOT NULL,
  `completion_summary` varchar(4000) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `submitter_user_id` bigint NOT NULL,
  `submitted_at` datetime NOT NULL,
  `confirmation_decision` varchar(32) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'approved/rejected/auto_approved',
  `confirmation_comment` varchar(1000) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `tenant_id` bigint NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
  UNIQUE KEY `uk_tenant_task_revision` (`tenant_id`,`task_id`,`revision_no`),
...
CREATE TABLE IF NOT EXISTS `zsjos_work_task` (
  ...
  `deliverable_requirement` varchar(2000) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `status` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'draft/pending/awaiting_confirmation/completed/cancelled',
...
-- zsjos_workbench_capacity
CREATE TABLE IF NOT EXISTS `zsjos_workbench_capacity` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `user_id` bigint NOT NULL,
  `staff_type` varchar(32) COLLATE utf8mb4_unicode_ci NOT NULL,
  `online_status` varchar(24) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'offline',
  `accepting` bit(1) NOT NULL DEFAULT b'0',
  `weighted_load` decimal(10,2) NOT NULL DEFAULT '0.00',
  `capacity_limit` decimal(10,2) DEFAULT NULL,
