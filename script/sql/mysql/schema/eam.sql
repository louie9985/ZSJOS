-- ZSJOS 运行项目 MySQL 空库结构基线。仅结构，不包含业务数据.
SET NAMES utf8mb4;
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='EAM 资产卡片';

-- eam_asset_change_log
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='EAM 资产变更记录';
...
CREATE TABLE IF NOT EXISTS `eam_asset_handover` (
  ...
  PRIMARY KEY (`id`),
  KEY `idx_eam_asset_handover_asset` (`tenant_id`,`asset_id`,`handover_time`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='EAM 资产交接历史';

-- eam_asset_import_batch
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='EAM 资产导入批次';

-- eam_asset_import_row
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='EAM 资产导入行来源';

-- eam_asset_verification
CREATE TABLE IF NOT EXISTS `eam_asset_verification` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `asset_id` bigint NOT NULL,
  `result` varchar(100) DEFAULT NULL,
  `label_status` varchar(20) DEFAULT NULL,
  `verifier_user_id` bigint DEFAULT NULL,
  `verifier_name_snapshot` varchar(100) DEFAULT NULL,
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='EAM 资产行政核对历史';
...
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='EAM 资产分类';
...
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='EAM 分类自定义字段定义';
...
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='EAM 资产编号规则';
...
CREATE TABLE IF NOT EXISTS `eam_demand` (
  ...
  `tenant_id` bigint NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
  UNIQUE KEY `uk_eam_demand_no` (`tenant_id`,`no`,`deleted`),
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='EAM 办公资产需求';
...
CREATE TABLE IF NOT EXISTS `eam_demand_item` (
  ...
  `delivery_mode_label_snapshot` varchar(50) NOT NULL,
  `custody_mode` tinyint NOT NULL,
  `custody_mode_label_snapshot` varchar(50) NOT NULL,
  `quantity` int NOT NULL,
  `unit` varchar(20) NOT NULL,
  `ext_fields` json DEFAULT NULL,
  `ext_field_labels` json DEFAULT NULL,
  ...
  `tenant_id` bigint NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
  KEY `idx_eam_demand_item_demand` (`tenant_id`,`demand_id`),
  KEY `idx_eam_demand_item_category` (`tenant_id`,`category_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='EAM 办公资产需求明细';

-- eam_employee_asset_task
CREATE TABLE IF NOT EXISTS `eam_employee_asset_task` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `event_key` varchar(160) NOT NULL,
  `latest_event_key` varchar(160) NOT NULL,
  `type` tinyint NOT NULL,
  `status` tinyint NOT NULL,
  `employee_id` bigint NOT NULL,
  `leader_user_id` bigint DEFAULT NULL,
  `employee_name_snapshot` varchar(100) NOT NULL,
  `dept_id_snapshot` bigint DEFAULT NULL,
  `process_instance_id` varchar(64) DEFAULT NULL,
  `demand_id` bigint DEFAULT NULL,
  `planned_leave_time` datetime DEFAULT NULL,
  `remark` varchar(500) DEFAULT NULL,
  `creator` varchar(64) DEFAULT '',
  `create_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `updater` varchar(64) DEFAULT '',
  ...
  `tenant_id` bigint NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
  UNIQUE KEY `uk_eam_employee_asset_task_event` (`tenant_id`,`event_key`,`deleted`),
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='EAM 员工配资、异动复核与离职结清任务';

-- eam_employee_asset_task_item
CREATE TABLE IF NOT EXISTS `eam_employee_asset_task_item` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `task_id` bigint NOT NULL,
  `asset_id` bigint DEFAULT NULL,
  `holding_id` bigint DEFAULT NULL,
  `asset_name_snapshot` varchar(220) NOT NULL,
  `action` tinyint DEFAULT NULL,
  `transfer_to_employee_id` bigint DEFAULT NULL,
  ...
  `tenant_id` bigint NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
  KEY `idx_eam_employee_asset_task_item_task` (`tenant_id`,`task_id`),
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='EAM 员工资产任务明细';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='EAM 盘点单';

-- eam_inventory_detail
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='EAM 盘点明细';

-- eam_public_asset_token
...
CREATE TABLE IF NOT EXISTS `eam_purchase` (
  ...
  `payment_mode_label_snapshot` varchar(100) NOT NULL,
  `supplier_name_snapshot` varchar(200) DEFAULT NULL,
  `supplier_contact_snapshot` varchar(200) DEFAULT NULL,
  `estimated_amount` decimal(14,2) DEFAULT NULL,
  `actual_amount` decimal(14,2) DEFAULT NULL,
  `expected_arrival_date` date DEFAULT NULL,
  `process_instance_id` varchar(64) DEFAULT NULL,
  `expense_status` tinyint NOT NULL DEFAULT '0',
  `expense_process_instance_id` varchar(64) DEFAULT NULL,
  `applicant_user_id` bigint NOT NULL,
  ...
  `tenant_id` bigint NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
  UNIQUE KEY `uk_eam_purchase_no` (`tenant_id`,`no`,`deleted`),
  KEY `idx_eam_purchase_status` (`tenant_id`,`status`,`create_time`),
  KEY `idx_eam_purchase_process` (`process_instance_id`),
  KEY `idx_eam_purchase_expense_process` (`expense_process_instance_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='EAM 轻量办公采购单';
...
CREATE TABLE IF NOT EXISTS `eam_purchase_item` (
  ...
  `short_closed_quantity` int NOT NULL DEFAULT '0',
  `short_close_remark` varchar(500) DEFAULT NULL,
  `unit` varchar(20) NOT NULL,
  ...
  `tenant_id` bigint NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
  KEY `idx_eam_purchase_item_purchase` (`tenant_id`,`purchase_id`),
  KEY `idx_eam_purchase_item_category` (`tenant_id`,`category_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='EAM 采购明细';

-- eam_purchase_source
CREATE TABLE IF NOT EXISTS `eam_purchase_source` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `purchase_item_id` bigint NOT NULL,
  `demand_item_id` bigint DEFAULT NULL,
  `quantity` int NOT NULL,
  `fulfilled_quantity` int NOT NULL DEFAULT '0',
  `closed_quantity` int NOT NULL DEFAULT '0',
  ...
  `tenant_id` bigint NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
  KEY `idx_eam_purchase_source_item` (`tenant_id`,`purchase_item_id`),
  KEY `idx_eam_purchase_source_demand` (`tenant_id`,`demand_item_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='EAM 采购来源与分配映射';
...
CREATE TABLE IF NOT EXISTS `eam_receipt` (
  ...
  `tenant_id` bigint NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
  UNIQUE KEY `uk_eam_receipt_no` (`tenant_id`,`no`,`deleted`),
  KEY `idx_eam_receipt_purchase` (`tenant_id`,`purchase_id`,`operate_time`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='EAM 入库与退货批次';
...
CREATE TABLE IF NOT EXISTS `eam_receipt_item` (
  ...
  `purchase_item_id` bigint NOT NULL,
  `stock_balance_id` bigint DEFAULT NULL,
  `quantity` int NOT NULL,
  `unit_price` decimal(14,2) DEFAULT NULL,
  `serial_numbers` json DEFAULT NULL,
  `actual_ext_fields` json DEFAULT NULL,
  `actual_ext_field_labels` json DEFAULT NULL,
  `actual_ext_field_dict_types` json DEFAULT NULL,
  `creator` varchar(64) DEFAULT '',
  `create_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `updater` varchar(64) DEFAULT '',
  `update_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  ...
  `tenant_id` bigint NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
  KEY `idx_eam_receipt_item_receipt` (`tenant_id`,`receipt_id`),
  KEY `idx_eam_receipt_item_purchase_item` (`tenant_id`,`purchase_item_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='EAM 入库与退货批次明细';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='EAM 维修记录';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='EAM 报废单';
...
CREATE TABLE IF NOT EXISTS `eam_stock_balance` (
  ...
  `tenant_id` bigint NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
  UNIQUE KEY `uk_eam_stock_balance_match` (`tenant_id`,`category_id`,`unit`,`management_mode`,`delivery_mode`,`custody_mode`,`attribute_signature`,`deleted`),
  KEY `idx_eam_stock_balance_alert` (`tenant_id`,`minimum_quantity`,`next_expiry_date`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='EAM 全公司库存余额';
...
CREATE TABLE IF NOT EXISTS `eam_stock_holding` (
  ...
  `return_applied_at` datetime DEFAULT NULL,
  `return_inspected_at` datetime DEFAULT NULL,
  `return_result` tinyint DEFAULT NULL,
  ...
  `tenant_id` bigint NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
  KEY `idx_eam_stock_holding_employee` (`tenant_id`,`employee_id`,`status`),
  KEY `idx_eam_stock_holding_asset` (`tenant_id`,`asset_id`,`status`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='EAM 员工批量或待签收持有明细';
...
CREATE TABLE IF NOT EXISTS `eam_stock_movement` (
  ...
  `tenant_id` bigint NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
  KEY `idx_eam_stock_movement_balance` (`tenant_id`,`stock_balance_id`,`operate_time`),
  KEY `idx_eam_stock_movement_business` (`tenant_id`,`business_type`,`business_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='EAM 库存流水';
...
CREATE TABLE IF NOT EXISTS `eam_stock_reminder` (
  ...
  `tenant_id` bigint NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
  UNIQUE KEY `uk_eam_stock_reminder` (`tenant_id`,`scene`,`business_type`,`business_id`,`reminder_date`,`deleted`),
  KEY `idx_eam_stock_reminder_status` (`tenant_id`,`status`,`due_date`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='EAM 低库存与数字资产到期提醒投影';

-- eam_stock_reservation
CREATE TABLE IF NOT EXISTS `eam_stock_reservation` (
  ...
  `tenant_id` bigint NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
  KEY `idx_eam_stock_reservation_demand` (`tenant_id`,`demand_item_id`,`status`),
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='EAM 库存预留';
...
CREATE TABLE IF NOT EXISTS `eam_transfer` (
  ...
  `asset_id` bigint NOT NULL COMMENT '资产编号',
  `asset_code_snapshot` varchar(100) DEFAULT NULL COMMENT '资产业务编号快照',
  `asset_name_snapshot` varchar(200) DEFAULT NULL COMMENT '资产名称快照',
  `type_label_snapshot` varchar(50) DEFAULT NULL COMMENT '流转类型名称快照',
  `from_employee_id` bigint DEFAULT NULL COMMENT '转出使用员工',
  `from_dept_id` bigint DEFAULT NULL COMMENT '转出部门',
  `from_employee_name_snapshot` varchar(100) DEFAULT NULL COMMENT '转出员工名称快照',
  `from_dept_name_snapshot` varchar(100) DEFAULT NULL COMMENT '转出部门名称快照',
  `to_employee_id` bigint DEFAULT NULL COMMENT '接收使用员工',
  `to_dept_id` bigint DEFAULT NULL COMMENT '接收部门',
  `to_employee_name_snapshot` varchar(100) DEFAULT NULL COMMENT '接收员工名称快照',
  `to_dept_name_snapshot` varchar(100) DEFAULT NULL COMMENT '接收部门名称快照',
  `expected_return_date` date DEFAULT NULL COMMENT '预计归还日期，仅借用',
  `actual_return_date` date DEFAULT NULL COMMENT '实际归还日期，仅归还',
  `status` tinyint NOT NULL DEFAULT '0' COMMENT '0审批中 1已生效 2已驳回 3已取消 4草稿 5待验收 6已完成 7异常',
  `process_instance_id` varchar(64) DEFAULT NULL COMMENT 'BPM 流程实例编号',
  `round_no` int NOT NULL DEFAULT '1' COMMENT '审批轮次',
  `reason` varchar(500) DEFAULT NULL COMMENT '事由',
  `apply_user_id` bigint DEFAULT NULL COMMENT '申请人编号',
  `apply_user_name_snapshot` varchar(100) DEFAULT NULL COMMENT '申请人名称快照',
  `apply_dept_id` bigint DEFAULT NULL COMMENT '申请部门编号',
  `apply_dept_name_snapshot` varchar(100) DEFAULT NULL COMMENT '申请部门名称快照',
  `apply_time` datetime DEFAULT NULL COMMENT '申请时间',
  `inspection_result` tinyint DEFAULT NULL COMMENT '验收结果：1完好 2损坏 3缺件或遗失 4不符',
  `inspection_remark` varchar(500) DEFAULT NULL COMMENT '验收备注',
  `inspection_file_urls` json DEFAULT NULL COMMENT '验收附件',
  `inspected_by_user_id` bigint DEFAULT NULL COMMENT '验收人',
  `inspected_at` datetime DEFAULT NULL COMMENT '验收时间',
  `version` int NOT NULL DEFAULT '0' COMMENT '乐观锁版本',
  `creator` varchar(64) DEFAULT '' COMMENT '创建者',
  `create_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `updater` varchar(64) DEFAULT '' COMMENT '更新者',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='EAM 资产流转单';
