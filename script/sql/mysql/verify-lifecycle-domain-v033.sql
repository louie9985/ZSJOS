-- Read-only preflight and post-migration verification for V033.
-- Run before V033 to identify blocking business relationships, then run again after V033.
...
SELECT 'v033_schema_and_status' AS check_name,
