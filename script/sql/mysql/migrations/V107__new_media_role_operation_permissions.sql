...
JOIN system_menu m ON m.permission IN (
  ...
  -- content director: director-owned students, accounts, content, positioning and handovers
  ...
  'zsjos:handover:query','zsjos:handover:create','zsjos:handover:accept','zsjos:handover:reject',
  'zsjos:handover:request-arbitration',
  ...
  'zsjos:positioning-card:sign','zsjos:handover:query','zsjos:handover:create','zsjos:handover:accept','zsjos:handover:reject',
  'zsjos:handover:request-arbitration','zsjos:student-ops:query','zsjos:student-ops:create-exception',
...
WHERE r.tenant_id=1 AND r.status=0 AND r.deleted=b'0' AND m.deleted=b'0'
  ...
  AND (
    ...
    OR (r.code='content_director' AND m.permission IN ('zsjos:media-student:query-my','zsjos:media-account:query','zsjos:media-account:edit','zsjos:media-account:bind-student','zsjos:media-account:stage-advance','zsjos:media-account:stage-rollback','zsjos:content:query','zsjos:content:create','zsjos:content:complete-topic','zsjos:content:submit-production','zsjos:content:submit-acceptance','zsjos:content:revise','zsjos:content:resubmit-production','zsjos:content:edit','zsjos:positioning-card:query','zsjos:positioning-card:create','zsjos:positioning-card:submit-review','zsjos:positioning-card:edit','zsjos:positioning-card:sign','zsjos:handover:query','zsjos:handover:create','zsjos:handover:accept','zsjos:handover:reject','zsjos:handover:request-arbitration'))
    OR (r.code='new_media_operator' AND m.permission IN ('zsjos:media-account:query','zsjos:media-account:create','zsjos:media-account:edit','zsjos:media-account:bind-student','zsjos:media-account:stage-advance','zsjos:media-account:stage-rollback','zsjos:media-account:diagnose','zsjos:media-account:rescue','zsjos:media-account:rebind','zsjos:content:query','zsjos:content:create','zsjos:content:complete-topic','zsjos:content:submit-production','zsjos:content:submit-acceptance','zsjos:content:acceptance-review','zsjos:content:revise','zsjos:content:resubmit-production','zsjos:content:edit','zsjos:production-ticket:query','zsjos:production-ticket:create','zsjos:production-ticket:accept','zsjos:production-ticket:produce','zsjos:production-ticket:submit','zsjos:production-ticket:check','zsjos:production-ticket:edit','zsjos:production-ticket:over-entitlement','zsjos:positioning-card:query','zsjos:positioning-card:create','zsjos:positioning-card:submit-review','zsjos:positioning-card:feasibility-review','zsjos:positioning-card:confirm-trial','zsjos:positioning-card:archive','zsjos:positioning-card:sign','zsjos:handover:query','zsjos:handover:create','zsjos:handover:accept','zsjos:handover:reject','zsjos:handover:request-arbitration','zsjos:student-ops:query','zsjos:student-ops:create-exception','zsjos:student-ops:resolve-exception','zsjos:student-ops:assess','zsjos:review:query','zsjos:review:approve'))
