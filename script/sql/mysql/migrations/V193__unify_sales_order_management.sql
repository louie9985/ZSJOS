-- V193: unify personal/team sales-order menus, permissions and filter templates.
...
SELECT 73511,'订单管理','zsjos:sales-order:query-management',2,17,6735,'sales-orders','ep:tickets','zsjos/mySalesOrder/index','ZsjosSalesOrderManagement',0,b'1',b'1',b'1','migration-V193',NOW(),'migration-V193',NOW(),b'0'
...
SELECT DISTINCT rm.role_id, menu.id, 'migration-V193', NOW(), 'migration-V193', NOW(), b'0', rm.tenant_id
...
SET rm.deleted=b'1', rm.updater='migration-V193', rm.update_time=NOW()
WHERE old_menu.permission IN ('zsjos:sales-order:query-own','zsjos:sales-order:query-team')
  AND rm.deleted=b'0';

UPDATE system_menu
SET deleted=b'1', status=1, visible=b'0', updater='migration-V193', update_time=NOW()
...
VALUES ('V193','Unify sales order management menu and templates','V193__unify_sales_order_management.sql',NOW())
ON DUPLICATE KEY UPDATE description=VALUES(description), checksum=VALUES(checksum);
INSERT INTO zsjos_module_schema_version
(`module_code`,`version`,`description`,`checksum`,`release_version`,`installed_at`)
VALUES ('core','V193','Unify sales order management menu and templates',SHA2('V193__unify_sales_order_management.sql',256),'baseline',NOW())
ON DUPLICATE KEY UPDATE description=VALUES(description), checksum=VALUES(checksum);
