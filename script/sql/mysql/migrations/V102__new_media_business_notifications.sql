...
FROM (
 ...
 UNION ALL SELECT '交接待接收','ZSJOS_MEDIA_HANDOVER_PENDING_ACCEPT','media.handover.pending_accept','交接待接收','你有新的交接单待接收','交接单 {{bizNo}} 等待你接收。'
 UNION ALL SELECT '交接已接收','ZSJOS_MEDIA_HANDOVER_ACCEPTED','media.handover.accepted','交接已接收','对方已完成交接接收','交接单 {{bizNo}} 已被接收。'
 UNION ALL SELECT '交接已退回','ZSJOS_MEDIA_HANDOVER_REJECTED','media.handover.rejected','交接已退回','对方退回了交接单','交接单 {{bizNo}} 已退回，请查看原因并处理。'
...
JOIN (
 ...
 UNION ALL SELECT '交接待接收','media.handover.pending_accept','ZSJOS_MEDIA_HANDOVER_PENDING_ACCEPT'
 UNION ALL SELECT '交接已接收','media.handover.accepted','ZSJOS_MEDIA_HANDOVER_ACCEPTED'
 UNION ALL SELECT '交接已退回','media.handover.rejected','ZSJOS_MEDIA_HANDOVER_REJECTED'
