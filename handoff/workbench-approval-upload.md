...
- Unresolved risks: Live COS/BPM behavior and real authenticated approval filtering require runtime availability; existing migration continuity must be verified after V021-V028 integration.
