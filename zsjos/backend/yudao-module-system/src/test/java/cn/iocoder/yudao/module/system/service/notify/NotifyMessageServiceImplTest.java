...
public class NotifyMessageServiceImplTest extends BaseDbUnitTest {
    ...
    public void testCreateNotifyMessage_success() {
        ...
        assertEquals(template.getTitle(), message.getTemplateTitle());
        assertEquals(template.getSummary(), message.getTemplateSummary());
        ...
        NotifyMessageCreatedEvent createdEvent = applicationEvents.stream(NotifyMessageCreatedEvent.class)
                .findFirst().orElseThrow();
        assertEquals(messageId, createdEvent.messageId());
        assertEquals(userId, createdEvent.userId());
        assertEquals(userType, createdEvent.userType());
    }
    ...
    @Test
    public void testGetMyNotifyMessage_enforcesOwnerAndUserType() {
        ...
        assertPojoEquals(dbNotifyMessage, notifyMessageService.getMyNotifyMessage(
                dbNotifyMessage.getId(), 1L, UserTypeEnum.ADMIN.getValue()));
        assertNull(notifyMessageService.getMyNotifyMessage(
                dbNotifyMessage.getId(), 2L, UserTypeEnum.ADMIN.getValue()));
        assertNull(notifyMessageService.getMyNotifyMessage(
                dbNotifyMessage.getId(), 1L, UserTypeEnum.MEMBER.getValue()));
    }
