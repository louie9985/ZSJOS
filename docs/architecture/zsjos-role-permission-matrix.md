...
| 4 | `new_media_operator` | `/zsjos/media-students`、第三方账号、内容生产、拍剪核对、账号定位复核和学员运营；学员范围仅限本人负责账号、内容、定位或任务关联对象 |
...
| 12 | `study_planner` | `/zsjos/my-students`、学习规划师联系/交付操作、专用学员复购和本人订单；不默认授予新媒体“学员运营”，不授予通用订单录入或外部历史客户复购，仅本人负责的服务关系 |
