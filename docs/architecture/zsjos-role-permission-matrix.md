...
| 4 | `new_media_operator` | 保持已批准的提交方和组织范围能力，不按名称扩权 |
| 5 | `filming_editor` | 零 ZSJOS 菜单，当前没有已落地职责 |
| 6 | `sales_manager` | 保持团队客资、公海管理、投诉处理、申诉一审、下属销售管理和订单主管确认能力 |
| 7 | `sales_specialist` | 保持本人客资、接单/抢单、跟进判定、自拓、建单、本人订单、公海申请和本人工作计划能力 |
